var V=Object.defineProperty;var I=(a,e,t)=>e in a?V(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var f=(a,e,t)=>I(a,typeof e!="symbol"?e+"":e,t);import{r as g,C,I as E,R as w,a as z}from"./lT7bFEJw.js";const M=`
struct Params {
	frame: f32,
	loop_phase: f32,
	node_count: f32,
...
`,B="rgba16float",P=2048,G=16;class Y{constructor(e){f(this,"engine");f(this,"cells",[]);f(this,"scalars",{});f(this,"intensity",.28);f(this,"well",{x:0,y:0,hw:-1,hh:0,floor:.1,soft:.22});f(this,"lastAspectBucket",-999);f(this,"resources",null);f(this,"sampler",null);f(this,"splatBindLayout",null);f(this,"blurBindLayout",null);f(this,"membraneBindLayout",null);f(this,"splatPipeline",null);f(this,"blurPipeline",null);f(this,"membranePipeline",null);f(this,"cellPipeline",null);f(this,"cellCount",0);this.engine=e}setIntensity(e){this.intensity=Math.min(1,Math.max(0,Number.isFinite(e)?e:.28));const t=this.engine.gpuDevice;t&&this.writeOpts(t),this.cells.length&&this.setCells(this.cells,this.scalars)}setCells(e,t={}){this.cells=e.slice(0,P),this.scalars=t;const s=this.engine.gpuDevice;s&&(this.ensurePipelines(s),this.ensureResources(s),this.uploadBuffers(s))}ensurePipelines(e){if(this.splatPipeline||!this.engine.paramsBuffer)return;const t=L(e,"living-field-splat",H),s=L(e,"living-field-blur",W),i=L(e,"living-field-membrane",$),n=L(e,"living-field-cell",Q);this.splatBindLayout=e.createBindGroupLayout({label:"living-field-splat-layout",entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.VERTEX,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),this.blurBindLayout=e.createBindGroupLayout({label:"living-field-blur-layout",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),this.membraneBindLayout=e.createBindGroupLayout({label:"living-field-membrane-layout",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}}]});const l=e.createPipelineLayout({label:"living-field-splat-pl",bindGroupLayouts:[this.splatBindLayout]}),r=e.createPipelineLayout({label:"living-field-blur-pl",bindGroupLayouts:[this.blurBindLayout]}),c=e.createPipelineLayout({label:"living-field-membrane-pl",bindGroupLayouts:[this.membraneBindLayout]});this.sampler=e.createSampler({magFilter:"linear",minFilter:"linear"});const o={color:{srcFactor:"one",dstFactor:"one",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one",operation:"add"}};this.splatPipeline=e.createRenderPipeline({label:"living-field-splat",layout:l,vertex:{module:t,entryPoint:"vs_splat"},fragment:{module:t,entryPoint:"fs_splat",targets:[{format:B,blend:o}]},primitive:{topology:"triangle-list"}}),this.blurPipeline=e.createRenderPipeline({label:"living-field-blur",layout:r,vertex:{module:s,entryPoint:"vs_fullscreen"},fragment:{module:s,entryPoint:"fs_blur",targets:[{format:B}]},primitive:{topology:"triangle-list"}}),this.membranePipeline=e.createRenderPipeline({label:"living-field-membrane",layout:c,vertex:{module:i,entryPoint:"vs_fullscreen"},fragment:{module:i,entryPoint:"fs_membrane",targets:[{format:this.engine.sceneFormat,blend:o}]},primitive:{topology:"triangle-list"}}),this.cellPipeline=e.createRenderPipeline({label:"living-field-cells",layout:l,vertex:{module:n,entryPoint:"vs_cell"},fragment:{module:n,entryPoint:"fs_cell",targets:[{format:this.engine.sceneFormat,blend:o}]},primitive:{topology:"triangle-list"}})}ensureResources(e){var R,A,U,O,F,T;if(!this.splatBindLayout||!this.blurBindLayout||!this.membraneBindLayout||!this.engine.paramsBuffer||!this.sampler)return;const t=Math.max(16,Math.floor((this.engine.params[6]||1280)/2)),s=Math.max(16,Math.floor((this.engine.params[7]||720)/2)),i=!this.resources||this.resources.fieldSize[0]!==t||this.resources.fieldSize[1]!==s;let n=(R=this.resources)==null?void 0:R.cellBuffer,l=(A=this.resources)==null?void 0:A.blurHBuffer,r=(U=this.resources)==null?void 0:U.blurVBuffer,c=(O=this.resources)==null?void 0:O.optsBuffer;if(n||(n=e.createBuffer({label:"living-field-cells",size:P*G*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST})),l||(l=e.createBuffer({label:"living-field-blur-h",size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),e.queue.writeBuffer(l,0,new Float32Array([1,0,0,0]))),r||(r=e.createBuffer({label:"living-field-blur-v",size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),e.queue.writeBuffer(r,0,new Float32Array([0,1,0,0]))),c||(c=e.createBuffer({label:"living-field-opts",size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})),!i&&this.resources)return;(F=this.resources)==null||F.fieldA.destroy(),(T=this.resources)==null||T.fieldB.destroy();const o=GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING,u=e.createTexture({label:"living-field-a",size:[t,s],format:B,usage:o}),m=e.createTexture({label:"living-field-b",size:[t,s],format:B,usage:o}),b=u.createView(),p=m.createView(),h=e.createBindGroup({label:"living-field-splat-bind",layout:this.splatBindLayout,entries:[{binding:0,resource:{buffer:this.engine.paramsBuffer}},{binding:1,resource:{buffer:n}},{binding:2,resource:{buffer:c}}]}),v=e.createBindGroup({label:"living-field-cell-bind",layout:this.splatBindLayout,entries:[{binding:0,resource:{buffer:this.engine.paramsBuffer}},{binding:1,resource:{buffer:n}},{binding:2,resource:{buffer:c}}]}),x=e.createBindGroup({label:"living-field-blur-h-bind",layout:this.blurBindLayout,entries:[{binding:0,resource:this.sampler},{binding:1,resource:b},{binding:2,resource:{buffer:l}}]}),y=e.createBindGroup({label:"living-field-blur-v-bind",layout:this.blurBindLayout,entries:[{binding:0,resource:this.sampler},{binding:1,resource:p},{binding:2,resource:{buffer:r}}]}),k=e.createBindGroup({label:"living-field-membrane-bind",layout:this.membraneBindLayout,entries:[{binding:0,resource:{buffer:this.engine.paramsBuffer}},{binding:2,resource:{buffer:c}},{binding:3,resource:this.sampler},{binding:4,resource:b}]});this.resources={cellBuffer:n,blurHBuffer:l,blurVBuffer:r,optsBuffer:c,splatBindGroup:h,cellBindGroup:v,blurHBindGroup:x,blurVBindGroup:y,membraneBindGroup:k,fieldA:u,fieldB:m,fieldAView:b,fieldBView:p,fieldSize:[t,s]},this.writeOpts(e)}writeOpts(e){if(!this.resources)return;const t=this.portraitWell();e.queue.writeBuffer(this.resources.optsBuffer,0,new Float32Array([this.intensity,t.x,t.y,t.hw,t.hh,t.floor,t.soft,0]))}aspectBucket(){let e=this.engine.params[6]||0,t=this.engine.params[7]||0;return(e<=0||t<=0)&&typeof window<"u"&&(e=window.innerWidth,t=window.innerHeight),e<=0||t<=0?-999:Math.round(e/t*8)}portraitWell(){if(this.well.hw<=0)return this.well;let e=this.engine.params[6]||0,t=this.engine.params[7]||0;if((e<=0||t<=0)&&typeof window<"u"&&(e=window.innerWidth,t=window.innerHeight),e<=0||t<=0)return this.well;const s=e/t;if(s>=.85)return this.well;const i=S((.85-s)/(.85-.46)),n=.42*i,l=1+(1/Math.max(s,.2)-1)*(.72*i),r=1+.25*i;return{x:this.well.x*(1-n),y:j(this.well.y*l,-.98,.98),hw:Math.min(1.1,this.well.hw*r),hh:Math.min(1.1,this.well.hh*l),floor:this.well.floor,soft:this.well.soft}}setReadingWell(e){this.well={x:d(e.x),y:d(e.y),hw:d(e.hw,-1),hh:d(e.hh),floor:S(e.floor??.1),soft:Math.max(.02,d(e.soft??.22,.22))};const t=this.engine.gpuDevice;t&&this.writeOpts(t)}uploadBuffers(e){if(!this.resources)return;const t=new Float32Array(P*G);this.cellCount=Math.min(P,this.cells.length);for(let s=0;s<this.cellCount;s++){const i=this.cells[s],n=d(i.x),l=d(i.y),r=Math.hypot(n,l),c=d(i.phase);let o=0;i.selected&&(o|=1),i.scar&&(o|=2),d(i.energy)>.8&&(o|=4);const u=s*G;t[u+0]=n,t[u+1]=l,t[u+2]=Math.max(.006,d(i.radius,.02)),t[u+3]=r,t[u+4]=d(i.hue[0]),t[u+5]=d(i.hue[1]),t[u+6]=d(i.hue[2]),t[u+7]=S(i.energy),t[u+8]=c,t[u+9]=o,t[u+10]=S(i.metric2??i.energy),t[u+11]=d(i.spin??1,1),t[u+12]=s,t[u+13]=d(i.seed??c*97.13),t[u+14]=this.intensity,t[u+15]=0}e.queue.writeBuffer(this.resources.cellBuffer,0,t)}compute(e){const t=this.engine.gpuDevice;if(!t||!this.resources||!this.splatPipeline||!this.blurPipeline)return;this.ensureResources(t);const s=this.aspectBucket();s!==this.lastAspectBucket&&(this.lastAspectBucket=s,this.writeOpts(t));const i=this.resources,n=e.beginRenderPass({label:"living-field-splat-pass",colorAttachments:[{view:i.fieldAView,clearValue:{r:0,g:0,b:0,a:0},loadOp:"clear",storeOp:"store"}]});n.setPipeline(this.splatPipeline),n.setBindGroup(0,i.splatBindGroup),this.cellCount>0&&n.draw(6,this.cellCount),n.end();const l=e.beginRenderPass({label:"living-field-blur-h",colorAttachments:[{view:i.fieldBView,clearValue:{r:0,g:0,b:0,a:0},loadOp:"clear",storeOp:"store"}]});l.setPipeline(this.blurPipeline),l.setBindGroup(0,i.blurHBindGroup),l.draw(6,1),l.end();const r=e.beginRenderPass({label:"living-field-blur-v",colorAttachments:[{view:i.fieldAView,clearValue:{r:0,g:0,b:0,a:0},loadOp:"clear",storeOp:"store"}]});r.setPipeline(this.blurPipeline),r.setBindGroup(0,i.blurVBindGroup),r.draw(6,1),r.end()}render(e){!this.resources||!this.membranePipeline||!this.cellPipeline||(e.setPipeline(this.membranePipeline),e.setBindGroup(0,this.resources.membraneBindGroup),e.draw(6,1),this.cellCount>0&&(e.setPipeline(this.cellPipeline),e.setBindGroup(0,this.resources.cellBindGroup),e.draw(6,this.cellCount)))}orbitCpu(e,t,s,i){const n=Math.hypot(e,t);if(n<1e-4)return{x:e,y:t};const l=this.engine.params[10]||0,r=Math.atan2(t,e),c=(.045+s*.1)*l*i,o=r+c+Math.sin(l*.6+s*Math.PI*2)*.02,u=n*(1+.016*Math.sin(l*1.1+s*Math.PI*2));return{x:Math.cos(o)*u,y:Math.sin(o)*u}}pickAt(e,t){let s=null,i=1/0;for(let n=0;n<this.cellCount;n++){const l=this.cells[n],r=this.orbitCpu(l.x,l.y,l.phase,l.spin??1),c=Math.hypot(e-r.x,t-r.y),o=Math.max(.04,l.radius*2.6);c<=o&&c<i&&(s={id:l.pickId,kind:l.kind??"living-cell",index:n,payload:l.payload??l},i=c)}return s}dispose(){var e,t,s,i,n,l;(e=this.resources)==null||e.cellBuffer.destroy(),(t=this.resources)==null||t.blurHBuffer.destroy(),(s=this.resources)==null||s.blurVBuffer.destroy(),(i=this.resources)==null||i.optsBuffer.destroy(),(n=this.resources)==null||n.fieldA.destroy(),(l=this.resources)==null||l.fieldB.destroy(),this.resources=null}}function S(a){return Math.min(1,Math.max(0,Number.isFinite(a)?a:0))}function j(a,e,t){return Math.min(t,Math.max(e,Number.isFinite(a)?a:e))}function d(a,e=0){return Number.isFinite(a)?a:e}function L(a,e,t){a.pushErrorScope("validation");const s=a.createShaderModule({label:e,code:t});return s.getCompilationInfo().then(i=>{for(const n of i.messages)n.type==="error"&&console.error(`[living-field] ${e} WGSL ${n.type} ${n.lineNum}:${n.linePos} ${n.message}`)}),a.popErrorScope().then(i=>{i&&console.error(`[living-field] ${e} shader module validation: ${i.message}`)}),s}const N=2.399963229728653;function J(a,e={}){const t=a.length;if(t===0)return[];const s=e.maxRadius??.92,i=e.minCellR??.012,n=e.maxCellR??.05;return a.map((r,c)=>({d:r,i:c})).sort((r,c)=>(c.d.score||0)-(r.d.score||0)).map(({d:r},c)=>{const o=t>1?c/(t-1):0,u=s*Math.sqrt(.06+.94*o),m=c*N,b=Math.cos(m)*u,p=Math.sin(m)*u,h=_(r.score),v=i+(n-i)*Math.sqrt(h);return{x:b,y:p,radius:v,hue:D(r.hue,h),energy:_(r.energy??.35+.65*h),phase:c/t,pickId:r.id,kind:r.kind,payload:r.payload??r,selected:r.selected,scar:r.scar,metric2:_(r.metric2??h),spin:1}})}function K(a,e,t={}){if(a.length===0)return[];const i=t.maxRadius??.9,n=t.minCellR??.014,l=t.maxCellR??.05,r=Math.max(1,t.ringCount??new Set(a.map(e)).size),c=new Map;return a.map((o,u)=>{const m=e(o,u),p=((Number.isFinite(m)?Math.floor(m):0)%r+r)%r,h=c.get(p)??0;c.set(p,h+1);const v=i*(.18+.82*(p/Math.max(1,r-1))),x=h*N+p*.7,y=_(o.score);return{x:Math.cos(x)*v,y:Math.sin(x)*v,radius:n+(l-n)*Math.sqrt(y),hue:D(o.hue,y),energy:_(o.energy??.35+.65*y),phase:p/r,pickId:o.id,kind:o.kind,payload:o.payload??o,selected:o.selected,scar:o.scar,metric2:_(o.metric2??y),spin:1}})}const Z={oxygen:g(w.luciferin),healthy:g(w.healthy),recall:g(w.recall),bridge:g(w.bridge),debt:g(w.debt),scarlet:g(E.veto),caution:g(E.caution),forward:g(C.forward),retrograde:g(C.retrograde)};function _(a){return Math.min(1,Math.max(0,Number.isFinite(a)?a:0))}function D(a,e){const t=a??z(e);return[Number.isFinite(t[0])?t[0]:0,Number.isFinite(t[1])?t[1]:0,Number.isFinite(t[2])?t[2]:0]}export{Z as F,Y as L,K as a,J as l};
