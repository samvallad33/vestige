var gi=Object.defineProperty;var vi=(i,e,t)=>e in i?gi(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var u=(i,e,t)=>vi(i,typeof e!="symbol"?e+"":e,t);import"./Bzak7iHL.js";import{d as wr,s as ee,b as he,o as bi,e as Oe}from"./CNdOtqLU.js";import{p as gt,c as M,r as E,j as D,t as oe,a as Y,b as vt,f as Z,k as xr,h as Lt,g as m,u as Ce,ao as Ne,d as j,e as ar,s as P,bi as yi,n as _i}from"./Dw_4PDAU.js";import{i as J,b as wi}from"./C7WW_yYn.js";import{e as Mt,s as Ee}from"./S5IcwJEO.js";import{s as Re,r as xi}from"./sbNTdgSE.js";import{b as Pi}from"./BHZaPctr.js";import{p as W}from"./N0ivUMqs.js";import{a as Bi,s as Si}from"./CSsWZzkN.js";import{a as kt}from"./B3oLbNAe.js";import{e as Ii}from"./DkSgzTIC.js";import{b as ki}from"./f2U-WYi5.js";import{s as At}from"./BDfpTd4R.js";import{t as Ri,d as Pr,N as _e,U as Rt,F as re,a as je,P as de,b as Ie,D as Dt,L as te,c as se,O as Ci,e as Ei}from"./Ce_AOQ7r.js";import{b as Mi,M as Ai,g as Fi}from"./D3ALi6cg.js";import{p as Gi}from"./CcSRZpDz.js";import{P as Li}from"./C1TqWGlj.js";function Di(i,e){var r;const t=[];for(const a of i){const n=(((r=a.activation_path)!=null&&r.length?a.activation_path:a.retrieved)??[]).filter(e);if(n.length===0)continue;const o=n[n.length-1];t.push({targetId:o,pathIds:n})}return t}function Ti(i,e=12){return[...i].sort((t,r)=>r.retention-t.retention||t.id.localeCompare(r.id)).slice(0,e).map(t=>({targetId:t.id,pathIds:[t.id]}))}function zi(i,e,t=5){var a;const r=new Map;for(const s of i){const n=((a=s.activation_path)!=null&&a.length?s.activation_path:s.retrieved)??[];for(const o of new Set(n))e(o)&&r.set(o,(r.get(o)??0)+1)}return[...r.entries()].map(([s,n])=>({id:s,recalls:n})).sort((s,n)=>n.recalls-s.recalls||s.id.localeCompare(n.id)).slice(0,t)}class Ui{constructor(e,t={}){u(this,"bridge");u(this,"items",[]);u(this,"cursor",0);u(this,"ticks",0);u(this,"nextTick",0);u(this,"intervalFrames");u(this,"enabled",!0);u(this,"started",!1);this.bridge=e,this.intervalFrames=Math.max(60,t.intervalFrames??240)}setItems(e){this.items=e,this.cursor=0}get itemCount(){return this.items.length}setEnabled(e){this.enabled=e}tick(e){if(!this.enabled||this.items.length===0)return;if(this.ticks++,!this.started){this.started=!0,this.nextTick=this.ticks+45;return}if(this.ticks<this.nextTick)return;if(this.bridge.hasActiveEvent){this.nextTick=this.ticks+90;return}const t=this.items[this.cursor%this.items.length];this.cursor++;const r=this.bridge.replayRecall(t.targetId,t.pathIds,e);this.nextTick=this.ticks+this.intervalFrames+(r?0:30)}}var Oi=Z('<span class="hidden lg:inline text-[#ffffff]/[0.5] whitespace-nowrap"> </span>'),Ni=Z('<span class="text-[#a6dcff] tracking-widest whitespace-nowrap">CAPTURE</span>'),ji=Z('<span class="text-[#5dcaa5] whitespace-nowrap w-[6ch] text-right"> </span>'),qi=Z('<div class="absolute top-0 left-0 right-0 z-20 pointer-events-none" style="padding-top: env(safe-area-inset-top);"><div class="flex items-center justify-between gap-3 px-4 py-2 bg-gradient-to-b from-[#05060a]/85 to-transparent font-mono text-xs [font-variant-numeric:tabular-nums]"><div class="flex items-center gap-3 min-w-0 flex-1 overflow-hidden"><span class="text-[#5dcaa5] tracking-widest uppercase truncate"> </span> <span class="hidden md:inline text-[#ffffff]/[0.5] whitespace-nowrap"> </span></div> <div class="hidden sm:flex items-center gap-4"><span class="text-[#ffffff]/[0.55] whitespace-nowrap"> </span> <!></div> <div class="flex items-center gap-3"><span class="text-[#ffffff]/[0.55] whitespace-nowrap"> </span> <!> <button class="text-[#ffffff]/[0.5] hover:text-[#5dcaa5] transition-colors cursor-pointer pointer-events-auto whitespace-nowrap" title="Copy shareable demo URL">[url]</button></div></div></div>');function Vi(i,e){gt(e,!0);let t=W(e,"demoMode",3,"recall-path"),r=W(e,"seed",3,"vestige-observatory-v1"),a=W(e,"nodeCount",3,0),s=W(e,"edgeCount",3,0),n=W(e,"centerId",3,""),o=W(e,"frameCount",3,0),c=W(e,"fpsEstimate",3,0),l=W(e,"freezeFrame",3,null);W(e,"loading",3,!1),W(e,"error",3,"");function d(){const q=new URLSearchParams({demo:t(),seed:r()});l()!==null&&q.set("frame",String(l()));const T=`${window.location.origin}${ki}/observatory?${q.toString()}`;navigator.clipboard.writeText(T).catch(()=>{})}var f=qi(),h=M(f),p=M(h),v=M(p),b=M(v,!0);E(v);var w=D(v,2),S=M(w);E(w),E(p);var y=D(p,2),z=M(y),U=M(z);E(z);var ne=D(z,2);{var A=q=>{var T=Oi(),x=M(T);E(T),oe(G=>ee(x,`center=${G??""}`),[()=>n().slice(0,8)]),Y(q,T)};J(ne,q=>{n()&&q(A)})}E(y);var H=D(y,2),F=M(H),K=M(F);E(F);var ie=D(F,2);{var ae=q=>{var T=Ni();Y(q,T)},ge=q=>{var T=ji(),x=M(T);E(T),oe(()=>ee(x,`${c()??""}fps`)),Y(q,T)};J(ie,q=>{l()!==null?q(ae):c()>0&&q(ge,1)})}var le=D(ie,2);E(H),E(h),E(f),oe((q,T)=>{ee(b,t()),ee(S,`seed=${q??""}${r().length>12?"…":""}`),ee(U,`${a()??""} nodes · ${s()??""} edges`),ee(K,`frame: ${T??""}`)},[()=>r().slice(0,12),()=>String(o()).padStart(3," ")]),he("click",le,d),Y(i,f),vt()}wr(["click"]);var Wi=Z('<div class="active-label svelte-8n8iia"> </div>'),Yi=Z("<div></div>"),Hi=Z('<div class="spine svelte-8n8iia"><!> <div class="track svelte-8n8iia"><!> <div class="playhead svelte-8n8iia"></div></div></div>');function Ki(i,e){gt(e,!0);let t=W(e,"steps",19,()=>[]),r=W(e,"frame",3,0),a=W(e,"loopFrames",3,720);const s=f=>f/a()*100;function n(f,h){const p=h-f;return p<-14||p>90?0:p<0?1+p/14:1-p/90}let o=Ce(()=>{let f="",h=.15;for(const p of t()){const v=n(p.beatFrame,r());v>h&&(h=v,f=p.label)}return f});var c=xr(),l=Lt(c);{var d=f=>{var h=Hi(),p=M(h);{var v=y=>{var z=Wi(),U=M(z,!0);E(z),oe(()=>ee(U,m(o))),Y(y,z)};J(p,y=>{m(o)&&y(v)})}var b=D(p,2),w=M(b);Mt(w,17,t,y=>y.beatFrame,(y,z)=>{var U=Yi();let ne;oe((A,H,F)=>{ne=Ee(U,1,"tick svelte-8n8iia",null,ne,A),At(U,`left: ${H??""}%; opacity: ${F??""}`),Re(U,"title",m(z).label)},[()=>({hot:n(m(z).beatFrame,r())>0,backward:m(z).kind===1}),()=>s(m(z).beatFrame),()=>.45+.55*n(m(z).beatFrame,r())]),Y(y,U)});var S=D(w,2);E(b),E(h),oe(y=>At(S,`left: ${y??""}%`),[()=>s(r())]),Y(f,h)};J(l,f=>{t().length>0&&f(d)})}Y(i,c),vt()}var Xi=Z('<div><div class="k svelte-ssd7yu"> </div> <div class="v svelte-ssd7yu"> </div> <div class="s svelte-ssd7yu"> </div></div>');function sr(i,e){gt(e,!0);let t=W(e,"frame",3,0),r=W(e,"fadeWindow",19,()=>[600,620,705,719]),a=W(e,"tone",3,"triumph");const s=(d,f,h)=>{const p=Math.min(1,Math.max(0,(h-d)/(f-d)));return p*p*(3-2*p)};let n=Ce(()=>s(r()[0],r()[1],t())*(1-s(r()[2],r()[3],t())));var o=xr(),c=Lt(o);{var l=d=>{var f=Xi();let h;var p=M(f),v=M(p,!0);E(p);var b=D(p,2),w=M(b,!0);E(b);var S=D(b,2),y=M(S,!0);E(S),E(f),oe(()=>{h=Ee(f,1,"verdict svelte-ssd7yu",null,h,{quarantine:a()==="quarantine"}),At(f,`opacity: ${m(n)??""}`),ee(v,e.verdict.headline),ee(w,e.verdict.causeLabel),ee(y,e.verdict.receipt)}),Y(d,f)};J(c,d=>{m(n)>.001&&d(l)})}Y(i,o),vt()}function Qi(i,e,t,r){const a=1/Math.tan(i/2),s=1/(t-r),n=new Float32Array(16);return n[0]=a/e,n[5]=a,n[10]=r*s,n[11]=-1,n[14]=r*t*s,n}function Zi(i,e,t){const[r,a,s]=i;let n=r-e[0],o=a-e[1],c=s-e[2],l=Math.hypot(n,o,c)||1;n/=l,o/=l,c/=l;let d=t[1]*c-t[2]*o,f=t[2]*n-t[0]*c,h=t[0]*o-t[1]*n;l=Math.hypot(d,f,h)||1,d/=l,f/=l,h/=l;const p=o*h-c*f,v=c*d-n*h,b=n*f-o*d,w=new Float32Array(16);return w[0]=d,w[1]=p,w[2]=n,w[4]=f,w[5]=v,w[6]=o,w[8]=h,w[9]=b,w[10]=c,w[12]=-(d*r+f*a+h*s),w[13]=-(p*r+v*a+b*s),w[14]=-(n*r+o*a+c*s),w[15]=1,w}function Ji(i,e){const t=new Float32Array(16);for(let r=0;r<4;r++)for(let a=0;a<4;a++)t[r*4+a]=i[a]*e[r*4]+i[4+a]*e[r*4+1]+i[8+a]*e[r*4+2]+i[12+a]*e[r*4+3];return t}function $i(i,e,t,r=.35,a=0){const s=i*Math.PI*2+a,n=[Math.sin(s)*t,t*r,Math.cos(s)*t],o=Qi(50*Math.PI/180,e,.1,4e3),c=Zi(n,[0,0,0],[0,1,0]);let l=-n[0],d=-n[1],f=-n[2],h=Math.hypot(l,d,f)||1;l/=h,d/=h,f/=h;let p=d*0-f*1,v=f*0-l*0,b=l*1-d*0;h=Math.hypot(p,v,b)||1,p/=h,v/=h,b/=h;const w=v*f-b*d,S=b*l-p*f,y=p*d-v*l;return{viewProj:Ji(o,c),right:[p,v,b],up:[w,S,y],eye:n}}const pt={yaw:0,pitch:0,zoom:1},en=.38,tn=2.6,rn=-.18,nn=.82;function Ft(i,e,t){return Math.min(t,Math.max(e,i))}function ft(i){return{yaw:Number.isFinite(i.yaw)?i.yaw:0,pitch:Ft(Number.isFinite(i.pitch)?i.pitch:0,rn,nn),zoom:Ft(Number.isFinite(i.zoom)?i.zoom:1,en,tn)}}function an(i,e,t,r=pt){const a=ft(r);return $i(i,e,t/a.zoom,.35+a.pitch,a.yaw)}class sn{constructor(){u(this,"state",{...pt});u(this,"dragging",!1);u(this,"pointerId",null);u(this,"lastX",0);u(this,"lastY",0);u(this,"pinch0",0);u(this,"pointers",new Map);u(this,"enabled",!0)}reset(){this.state={...pt},this.dragging=!1,this.pointerId=null,this.pointers.clear()}onPointerDown(e){var t,r;!this.enabled||e.button!==0||(this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.pointers.size===1?(this.dragging=!0,this.pointerId=e.pointerId,this.lastX=e.clientX,this.lastY=e.clientY,(r=(t=e.currentTarget)==null?void 0:t.setPointerCapture)==null||r.call(t,e.pointerId)):this.pointers.size===2&&(this.pinch0=or(this.pointers)))}onPointerMove(e){if(!this.enabled)return!1;if(this.pointers.has(e.pointerId)&&this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.pointers.size===2&&this.pinch0>0){const a=or(this.pointers),s=a/this.pinch0;return this.state=ft({...this.state,zoom:this.state.zoom*Ft(s,.94,1.06)}),this.pinch0=a,!0}if(!this.dragging||e.pointerId!==this.pointerId)return!1;const t=e.clientX-this.lastX,r=e.clientY-this.lastY;return this.lastX=e.clientX,this.lastY=e.clientY,this.state=ft({yaw:this.state.yaw-t*.005,pitch:this.state.pitch+r*.003,zoom:this.state.zoom}),!0}onPointerUp(e){this.pointers.delete(e.pointerId),e.pointerId===this.pointerId&&(this.dragging=!1,this.pointerId=null),this.pointers.size<2&&(this.pinch0=0)}onWheel(e){if(!this.enabled)return!1;e.preventDefault();const t=e.deltaY>0?.92:1.08;return this.state=ft({...this.state,zoom:this.state.zoom*t}),!0}}function or(i){const e=[...i.values()];return e.length<2?0:Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y)}function lr(i){const e=/^#?([0-9a-fA-F]{6})$/.exec(i.trim());if(!e)return[107/255,114/255,128/255];const t=parseInt(e[1],16);return[(t>>16&255)/255,(t>>8&255)/255,(t&255)/255]}function on(i){const e=Mi({tags:i.tags});return lr(e||Ai[Fi(i.retention)])}function ln(i){const t=[...i.nodes].sort((n,o)=>n.isCenter!==o.isCenter?n.isCenter?-1:1:n.id<o.id?-1:n.id>o.id?1:0).map((n,o)=>Ri(n,o)),r=new Map;for(const n of t)r.set(n.id,n.index);const a=[];for(const n of i.edges){const o=r.get(n.source),c=r.get(n.target);o===void 0||c===void 0||o===c||a.push({sourceIndex:o,targetIndex:c,weight:n.weight,type:n.type})}const s=t.findIndex(n=>n.isCenter);return{nodes:t,edges:a,indexById:r,centerIndex:s<0?0:s}}function Br(i,e,t=120){const r=i.nodes.length,a=new Float32Array(r*re);for(let s=0;s<r;s++){const n=i.nodes[s],o=s*re,[c,l,d]=n.isCenter&&i.centerIndex===s?[0,0,0]:Pr(s,r,t,e),f=n.isCenter?4.2:1.4+n.retention*1.8;a[o+_e.posRadius+0]=c,a[o+_e.posRadius+1]=l,a[o+_e.posRadius+2]=d,a[o+_e.posRadius+3]=f,a[o+_e.velRetention+3]=n.retention;const[h,p,v]=on(n);let b=0;n.isCenter&&(b|=je.isCenter),n.suppressed&&(b|=je.suppressed);const w=new Set(n.tags.map(S=>S.toLowerCase()));w.has("aha")&&(b|=je.isAha),(w.has("failure")||w.has("guardrail"))&&(b|=je.isFailure),(w.has("confusion")||w.has("weak-spot"))&&(b|=je.isConfusion),a[o+_e.colorFlags+0]=h,a[o+_e.colorFlags+1]=p,a[o+_e.colorFlags+2]=v,a[o+_e.colorFlags+3]=b}return{data:a,nodeCount:r}}function cr(i){const e=new Uint32Array(Math.max(1,i.edges.length)*Rt);return i.edges.forEach((t,r)=>{e[r*Rt]=t.sourceIndex,e[r*Rt+1]=t.targetIndex}),e}const cn=`
struct Params {
	frame: f32,
	loop_phase: f32,
	node_count: f32,
...
`;function fn(i){return 60+i*60}function Ir(i,e,t=8,r={}){var d;const a=[...i.nodes].sort((f,h)=>f.id<h.id?-1:f.id>h.id?1:0),s=[...i.edges].sort((f,h)=>{const p=`${f.source}\0${f.target}\0${f.type}`,v=`${h.source}\0${h.target}\0${h.type}`;return p<v?-1:p>v?1:0}),n=r.centerId??i.center_id,o=Gi(a,s,n,t,{preferCausal:r.preferCausal}),c=[];for(let f=0;f<o.beats.length;f++){const h=o.beats[f],p=e.indexById.get(h.nodeId);if(p===void 0)continue;const v=f>0?o.beats[f-1].nodeId:h.nodeId,b=e.indexById.get(v)??p,w=(((d=h.viaEdge)==null?void 0:d.type)??"").toLowerCase(),S=w==="causal"||w.includes("causal"),y=h.kind==="contradiction"||S;c.push({sourceIndex:b,targetIndex:p,beatFrame:fn(f),kind:y?de.backwardCause:de.recall,beatKind:h.kind,nodeId:h.nodeId,label:h.node.label})}const l=new Uint32Array(Math.max(1,c.length)*Ie);return c.forEach((f,h)=>{l[h*Ie]=f.sourceIndex,l[h*Ie+1]=f.targetIndex,l[h*Ie+2]=f.beatFrame,l[h*Ie+3]=f.kind}),{data:l,steps:c,path:o}}const hn=24,pn=300,Ge=128;class mn{constructor(e){u(this,"engine");u(this,"pipeline",null);u(this,"bindGroup",null);u(this,"cameraBuffer",null);u(this,"nodeBuffer",null);u(this,"edgeBuffer",null);u(this,"cameraData",new Float32Array(hn));u(this,"nodeCount",0);u(this,"simPipeline",null);u(this,"simBindGroup",null);u(this,"pathBuffer",null);u(this,"liveRetentionBuffer",null);u(this,"edgeCapacityBytes",0);u(this,"edgeCount",0);u(this,"cameraRig",{...pt});u(this,"hoveredIndex",-1);u(this,"pathPipeline",null);u(this,"pathBindGroup",null);u(this,"pathStepCount",0);u(this,"axonPipeline",null);u(this,"axonBindGroup",null);u(this,"graph",null);u(this,"pathSteps",[]);this.engine=e,e.addPass(this)}upload(e,t,r){var p,v,b,w;const a=this.engine.gpuDevice;if(!a)return;const s=(r==null?void 0:r.recallPath)??!0,n=ln(e);this.graph=n;const o=new Dt({seed:t}),{data:c,nodeCount:l}=Br(n,o.state.rng);this.nodeCount=l,(p=this.nodeBuffer)==null||p.destroy(),this.nodeBuffer=a.createBuffer({label:"observatory-node-state",size:Math.max(c.byteLength,64),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC|GPUBufferUsage.VERTEX}),a.queue.writeBuffer(this.nodeBuffer,0,c.buffer);const d=cr(n);this.edgeCount=n.edges.length,(v=this.edgeBuffer)==null||v.destroy(),this.edgeCapacityBytes=Math.max(d.byteLength*2,64),this.edgeBuffer=a.createBuffer({label:"observatory-edge-index",size:this.edgeCapacityBytes,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),a.queue.writeBuffer(this.edgeBuffer,0,d.buffer);const f=new Float32Array(Math.max(l,4));for(let S=0;S<l;S++)f[S]=Math.max(.001,n.nodes[S].retention);(b=this.liveRetentionBuffer)==null||b.destroy(),this.liveRetentionBuffer=a.createBuffer({label:"observatory-live-retention",size:f.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),a.queue.writeBuffer(this.liveRetentionBuffer,0,f.buffer);const h=s?Ir(e,n):{steps:[],data:new Uint32Array(4)};this.pathSteps=h.steps,(w=this.pathBuffer)==null||w.destroy(),this.pathBuffer=a.createBuffer({label:"observatory-path-steps",size:Ge*Ie*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),a.queue.writeBuffer(this.pathBuffer,0,h.data.buffer,0,Math.min(h.data.byteLength,Ge*Ie*4)),this.pathStepCount=Math.min(this.pathSteps.length,Ge),this.engine.params[2]=l,this.engine.params[3]=n.edges.length,this.engine.params[4]=this.pathSteps.length,this.cameraBuffer||(this.cameraBuffer=a.createBuffer({label:"observatory-camera",size:this.cameraData.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})),this.createPipeline(a)}setPathSteps(e,t){var s;const r=this.engine.gpuDevice;if(!r)return;this.pathSteps=t;const a=Ge*Ie*4;if(this.pathBuffer&&e.byteLength<=a){this.pathStepCount=Math.min(t.length,Ge),r.queue.writeBuffer(this.pathBuffer,0,e.buffer,0,e.byteLength),this.engine.params[4]=this.pathStepCount;return}this.pathStepCount=Math.min(t.length,Ge),(s=this.pathBuffer)==null||s.destroy(),this.pathBuffer=r.createBuffer({label:"observatory-path-steps",size:a,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),r.queue.writeBuffer(this.pathBuffer,0,e.buffer,0,Math.min(e.byteLength,a)),this.engine.params[4]=this.pathStepCount,this.createPipeline(r)}setCameraRig(e){this.cameraRig=e}setHovered(e){this.hoveredIndex=e}currentOrbit(){const e=this.engine.params[6]||1,t=this.engine.params[7]||1,r=this.engine.params[1];return an(r,e/t,pn,this.cameraRig)}setEdges(e){var n;const t=this.engine.gpuDevice;if(!t||!this.graph)return;this.graph.edges=e,this.edgeCount=e.length;const r=cr(this.graph),a=Math.max(r.byteLength,8);let s=!1;(!this.edgeBuffer||a>this.edgeCapacityBytes)&&((n=this.edgeBuffer)==null||n.destroy(),this.edgeCapacityBytes=Math.max(a*2,64),this.edgeBuffer=t.createBuffer({label:"observatory-edge-index",size:this.edgeCapacityBytes,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),s=!0),t.queue.writeBuffer(this.edgeBuffer,0,r.buffer),this.engine.params[3]=e.length,s&&this.createPipeline(t)}uploadLiveRetention(e){const t=this.engine.gpuDevice;if(!t||!this.liveRetentionBuffer)return;const r=Math.min(e.length,this.nodeCount);r<=0||t.queue.writeBuffer(this.liveRetentionBuffer,0,e.buffer,0,r*4)}getFossilLightSources(){return!this.nodeBuffer||!this.cameraBuffer||this.nodeCount<=0?null:{nodeBuffer:this.nodeBuffer,cameraBuffer:this.cameraBuffer,nodeCount:this.nodeCount}}createPipeline(e){if(!this.engine.paramsBuffer||!this.cameraBuffer||!this.nodeBuffer)return;if(this.pathBuffer){const r=e.createShaderModule({label:"observatory-simulate",code:dn});this.simPipeline=e.createComputePipeline({label:"observatory-recall-sim",layout:"auto",compute:{module:r,entryPoint:"recall_sim"}});const a=[{binding:0,resource:{buffer:this.engine.paramsBuffer}},{binding:1,resource:{buffer:this.nodeBuffer}},{binding:2,resource:{buffer:this.pathBuffer}}];this.edgeBuffer&&a.push({binding:3,resource:{buffer:this.edgeBuffer}}),this.liveRetentionBuffer&&a.push({binding:4,resource:{buffer:this.liveRetentionBuffer}}),this.simBindGroup=e.createBindGroup({label:"observatory-recall-sim-bind",layout:this.simPipeline.getBindGroupLayout(0),entries:a})}const t=e.createShaderModule({label:"observatory-render-nodes",code:cn});if(this.pipeline=e.createRenderPipeline({label:"observatory-nodes",layout:"auto",vertex:{module:t,entryPoint:"vs_main"},fragment:{module:t,entryPoint:"fs_main",targets:[{format:this.engine.sceneFormat,blend:{color:{srcFactor:"one",dstFactor:"one",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one",operation:"add"}}}]},primitive:{topology:"triangle-list"}}),this.bindGroup=e.createBindGroup({label:"observatory-nodes-bind",layout:this.pipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.engine.paramsBuffer}},{binding:1,resource:{buffer:this.cameraBuffer}},{binding:2,resource:{buffer:this.nodeBuffer}}]}),this.pathBuffer){const r=e.createShaderModule({label:"observatory-render-path",code:Sr});this.pathPipeline=e.createRenderPipeline({label:"observatory-path",layout:"auto",vertex:{module:r,entryPoint:"vs_main"},fragment:{module:r,entryPoint:"fs_main",targets:[{format:this.engine.sceneFormat,blend:{color:{srcFactor:"one",dstFactor:"one",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one",operation:"add"}}}]},primitive:{topology:"triangle-list"}}),this.pathBindGroup=e.createBindGroup({label:"observatory-path-bind",layout:this.pathPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.engine.paramsBuffer}},{binding:1,resource:{buffer:this.cameraBuffer}},{binding:2,resource:{buffer:this.nodeBuffer}},{binding:3,resource:{buffer:this.pathBuffer}}]})}if(this.edgeBuffer&&this.pathBuffer&&this.nodeBuffer){const r=e.createShaderModule({label:"observatory-render-axons",code:un});this.axonPipeline=e.createRenderPipeline({label:"observatory-axons",layout:"auto",vertex:{module:r,entryPoint:"vs_main"},fragment:{module:r,entryPoint:"fs_main",targets:[{format:this.engine.sceneFormat,blend:{color:{srcFactor:"one",dstFactor:"one",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one",operation:"add"}}}]},primitive:{topology:"line-list"}}),this.axonBindGroup=e.createBindGroup({label:"observatory-axons-bind",layout:this.axonPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.engine.paramsBuffer}},{binding:1,resource:{buffer:this.cameraBuffer}},{binding:2,resource:{buffer:this.edgeBuffer}},{binding:3,resource:{buffer:this.pathBuffer}},{binding:4,resource:{buffer:this.nodeBuffer}}]})}}compute(e){const t=this.engine.gpuDevice;if(!t||!this.cameraBuffer)return;const r=this.currentOrbit();if(this.cameraData.set(r.viewProj,0),this.cameraData[16]=r.right[0],this.cameraData[17]=r.right[1],this.cameraData[18]=r.right[2],this.cameraData[19]=0,this.cameraData[20]=r.up[0],this.cameraData[21]=r.up[1],this.cameraData[22]=r.up[2],this.cameraData[23]=0,t.queue.writeBuffer(this.cameraBuffer,0,this.cameraData),this.simPipeline&&this.simBindGroup&&this.nodeCount>0){const a=e.beginComputePass({label:"observatory-recall-sim"});a.setPipeline(this.simPipeline),a.setBindGroup(0,this.simBindGroup),a.dispatchWorkgroups(Math.ceil(this.nodeCount/64)),a.end()}}render(e){this.axonPipeline&&this.axonBindGroup&&this.edgeCount>0&&(e.setPipeline(this.axonPipeline),e.setBindGroup(0,this.axonBindGroup),e.draw(2,this.edgeCount)),!(!this.pipeline||!this.bindGroup||this.nodeCount===0)&&(e.setPipeline(this.pipeline),e.setBindGroup(0,this.bindGroup),e.draw(6,this.nodeCount),this.pathPipeline&&this.pathBindGroup&&this.pathStepCount>0&&(e.setPipeline(this.pathPipeline),e.setBindGroup(0,this.pathBindGroup),e.draw(6,this.pathStepCount)))}get nodeStateBuffer(){return this.nodeBuffer}get cameraUniformBuffer(){return this.cameraBuffer}get nodeCountValue(){return this.nodeCount}get pathStepMeta(){return this.pathSteps}async pickAt(e,t){const r=this.engine.gpuDevice;if(!r||!this.nodeBuffer||!this.graph||this.nodeCount===0)return null;const a=this.nodeCount*re*4,s=r.createBuffer({label:"observatory-pick-staging",size:a,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ}),n=r.createCommandEncoder({label:"observatory-pick-copy"});n.copyBufferToBuffer(this.nodeBuffer,0,s,0,a),r.queue.submit([n.finish()]);let o;try{await s.mapAsync(GPUMapMode.READ),o=new Float32Array(s.getMappedRange().slice(0))}catch{return s.destroy(),null}s.unmap(),s.destroy();const c=this.currentOrbit().viewProj,l=1/Math.tan(50*Math.PI/360);let d=-1,f=1/0;for(let h=0;h<this.nodeCount;h++){const p=h*re+_e.posRadius,v=o[p],b=o[p+1],w=o[p+2],S=o[p+3],y=c[3]*v+c[7]*b+c[11]*w+c[15];if(y<=0)continue;const z=(c[0]*v+c[4]*b+c[8]*w+c[12])/y,U=(c[1]*v+c[5]*b+c[9]*w+c[13])/y,ne=Math.max(S*l/y,.012),A=Math.hypot(z-e,U-t)/ne,H=h===this.hoveredIndex?.85:1;A<1.6*H&&A<f&&(f=A,d=h)}return d<0?null:{index:d,id:this.graph.nodes[d].id}}dispose(){var e,t,r,a,s;(e=this.nodeBuffer)==null||e.destroy(),(t=this.edgeBuffer)==null||t.destroy(),(r=this.cameraBuffer)==null||r.destroy(),(a=this.pathBuffer)==null||a.destroy(),(s=this.liveRetentionBuffer)==null||s.destroy(),this.nodeBuffer=null,this.edgeBuffer=null,this.cameraBuffer=null,this.pathBuffer=null,this.liveRetentionBuffer=null,this.pipeline=null,this.bindGroup=null,this.simPipeline=null,this.simBindGroup=null,this.pathPipeline=null,this.pathBindGroup=null,this.axonPipeline=null,this.axonBindGroup=null,this.edgeCapacityBytes=0,this.edgeCount=0}}const lt=16,qe=4,dr=110,gn=180,vn=.7,bn=.2,yn=360,_n=18;function wn(i){if(i.edges.length>0){const e=i.centerIndex,t=i.edges.filter(r=>r.sourceIndex===e||r.targetIndex===e);if(t.length>0){let r=-1,a=-1;for(const s of t){const n=s.sourceIndex===e?s.targetIndex:s.sourceIndex,o=i.nodes[n];o&&o.retention>a&&(a=o.retention,r=n)}if(r>=0)return r}}for(let e=0;e<i.nodes.length;e++)if(e!==i.centerIndex)return e;return i.centerIndex}function xn(i,e,t=8192){const r=wn(i),s=i.nodes[r].id,n=ur(i,r),c=new Dt({seed:e+":birth:"+s}).state.rng,l=new Float32Array(t*lt),d=Math.floor(t*vn),f=Math.floor(t*bn),h=t-d-f;for(let S=0;S<d;S++){const y=S*lt,[z,U,ne]=Pr(S,d,dr+c()*(gn-dr),c);l[y+0]=n[0]+z,l[y+1]=n[1]+U,l[y+2]=n[2]+ne,l[y+3]=c(),l[y+4]=n[0],l[y+5]=n[1],l[y+6]=n[2],l[y+7]=1+c()*1.8,l[y+8]=.91,l[y+9]=1,l[y+10]=.72,l[y+11]=c(),l[y+12]=0,l[y+13]=0,l[y+14]=0,l[y+15]=0}const p=i.edges.filter(S=>S.sourceIndex===r||S.targetIndex===r);for(let S=0;S<f;S++){const y=(d+S)*lt;if(p.length===0)continue;const z=S%p.length,U=p[z],ne=U.sourceIndex===r?U.targetIndex:U.sourceIndex,A=ur(i,ne),H=A[0]-n[0],F=A[1]-n[1],K=A[2]-n[2],ie=Math.sqrt(H*H+F*F+K*K)||1,ae=S/Math.max(1,f)*2+.5,ge=c()*30,le=-F*ge/ie,q=H*ge/ie,T=0;l[y+0]=n[0]+H/ie*ae*80+le,l[y+1]=n[1]+F/ie*ae*80+q,l[y+2]=n[2]+K/ie*ae*80+T,l[y+3]=c(),l[y+4]=n[0],l[y+5]=n[1],l[y+6]=n[2],l[y+7]=1+c()*1.8,l[y+8]=.91,l[y+9]=1,l[y+10]=.72,l[y+11]=c(),l[y+12]=0,l[y+13]=0,l[y+14]=0,l[y+15]=0}const v=300;for(let S=0;S<h;S++){const y=(d+f+S)*lt,z=c()*Math.PI*2,U=c()*120;l[y+0]=n[0]+Math.cos(z)*U,l[y+1]=n[1]+Math.sin(z)*U,l[y+2]=n[2]+v*.6+c()*40,l[y+3]=c(),l[y+4]=n[0],l[y+5]=n[1],l[y+6]=n[2],l[y+7]=1+c()*1.8,l[y+8]=.91,l[y+9]=1,l[y+10]=.72,l[y+11]=c(),l[y+12]=0,l[y+13]=0,l[y+14]=0,l[y+15]=0}const b=Pn(i,r),w=Bn();return{targetIndex:r,targetNodeId:s,particles:l,edgeSteps:b,timeline:w}}function ur(i,e){const t=i.nodes[e],r=i.nodes.length;if(t.isCenter&&i.centerIndex===e)return[0,0,0];const a=Math.PI*(3-Math.sqrt(5)),s=1-e/(r-1||1)*2,n=Math.sqrt(1-s*s),o=a*e,c=120,l=(e*7+3)%100/100*.1*c-.05*c,d=(e*13+7)%100/100*.1*c-.05*c,f=(e*17+11)%100/100*.1*c-.05*c;return[Math.cos(o)*n*c+l,s*c+d,Math.sin(o)*n*c+f]}function Pn(i,e){const t=i.edges.filter(s=>s.sourceIndex===e||s.targetIndex===e),r=t.length;if(r===0)return new Uint32Array(0);const a=new Uint32Array(r*qe);for(let s=0;s<r;s++){const n=t[s],o=n.sourceIndex===e?n.targetIndex:n.sourceIndex,c=yn+s*_n;a[s*qe+0]=e,a[s*qe+1]=o,a[s*qe+2]=c,a[s*qe+3]=0}return a}function Bn(){return[{label:"latent trace condensing",startFrame:60,endFrame:239},{label:"engram coalescence",startFrame:240,endFrame:329},{label:"memory ignition",startFrame:330,endFrame:359},{label:"associations engrave",startFrame:360,endFrame:509},{label:"stabilization",startFrame:510,endFrame:659}]}const Sn=`
struct Params {
	frame: f32,
	loop_phase: f32,
	node_count: f32,
...
`});this.renderPipeline=e.createRenderPipeline({label:"observatory-birth-render",layout:"auto",vertex:{module:r,entryPoint:"vs_main"},fragment:{module:r,entryPoint:"fs_main",targets:[{format:this.engine.sceneFormat,blend:{color:{srcFactor:"one",dstFactor:"one",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one",operation:"add"}}}]},primitive:{topology:"triangle-list"}});const a=this.nodeRenderer.cameraUniformBuffer;this.renderBindGroup=e.createBindGroup({label:"observatory-birth-render-bind",layout:this.renderPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.engine.paramsBuffer}},{binding:1,resource:{buffer:a}},{binding:2,resource:{buffer:this.particleBuffer}}]})}createHaloPipeline(e){const r=e.createShaderModule({label:"observatory-birth-halo",code:`
struct Params {
	frame: f32,
	loop_phase: f32,
	node_count: f32,
...
`}const Fn=2;class Gn{constructor(e){u(this,"engine");u(this,"nodeRenderer");u(this,"plan");u(this,"pipeline",null);u(this,"bindGroup",null);u(this,"waveBuffer",null);this.engine=e.engine,this.nodeRenderer=e.nodeRenderer,this.plan=e.plan,this.engine.addPass(this)}upload(){var r;const e=this.engine.gpuDevice;if(!e||!this.engine.paramsBuffer||!this.plan.viable||!this.nodeRenderer.nodeStateBuffer||this.nodeRenderer.nodeCountValue===0)return;(r=this.waveBuffer)==null||r.destroy(),this.waveBuffer=e.createBuffer({label:"observatory-rescue-wave",size:Math.max(4,this.plan.waveData.byteLength),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),e.queue.writeBuffer(this.waveBuffer,0,this.plan.waveData.buffer);const t=e.createShaderModule({label:"observatory-rescue-choreo",code:An(this.plan.consts)});this.pipeline=e.createComputePipeline({label:"observatory-rescue-choreo",layout:"auto",compute:{module:t,entryPoint:"rescue_choreo"}}),this.bindGroup=e.createBindGroup({label:"observatory-rescue-bind",layout:this.pipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.engine.paramsBuffer}},{binding:1,resource:{buffer:this.nodeRenderer.nodeStateBuffer}},{binding:2,resource:{buffer:this.waveBuffer}}]})}compute(e){if(this.engine.params[9]!==Fn||!this.pipeline||!this.bindGroup)return;const t=this.nodeRenderer.nodeCountValue;if(t===0)return;const r=e.beginComputePass({label:"observatory-rescue-choreo"});r.setPipeline(this.pipeline),r.setBindGroup(0,this.bindGroup),r.dispatchWorkgroups(Math.ceil(t/64)),r.end()}dispose(){var e;(e=this.waveBuffer)==null||e.destroy(),this.waveBuffer=null,this.pipeline=null,this.bindGroup=null}}const Ln=4,kr=90,Dn=138,Tn=28,ht=260,zn=514,fr=560,Rr=600,ke=65535,Un=48,On={causal:0,temporal:1,shared_concepts:2,complementary:3,semantic:4};function Cr(i,e){const t=new Dt({seed:e});return Br(i,t.state.rng).data}function Nn(i){const e=new Uint32Array(i.nodes.length);for(const t of i.edges)e[t.sourceIndex]++,e[t.targetIndex]++;return e}function jn(i,e){const t=i.nodes.length;if(t===0)return-1;const r=Nn(i),a=n=>{const o=i.nodes[n],c=new Set(o.tags.map(p=>p.toLowerCase()));let l=0;(c.has("failure")||c.has("guardrail"))&&(l+=3),(c.has("confusion")||c.has("weak-spot"))&&(l+=2),l+=Math.min(r[n],8)/8;const d=e[n*re+0],f=e[n*re+1],h=e[n*re+2];return Math.sqrt(d*d+f*f+h*h)>=54&&(l+=.5),l},s=[n=>n!==i.centerIndex&&!i.nodes[n].suppressed&&r[n]>=2,n=>n!==i.centerIndex&&!i.nodes[n].suppressed,n=>n!==i.centerIndex,()=>!0];for(const n of s){let o=-1,c=-1/0;for(let l=0;l<t;l++){if(!n(l))continue;const d=a(l);d>c&&(c=d,o=l)}if(o>=0)return o}return-1}function qn(i,e){const t=i.nodes.length,r=new Uint16Array(t).fill(ke),a=new Int32Array(t).fill(-1);if(e<0||e>=t)return{depths:r,parents:a};const s=Array.from({length:t},()=>[]);for(const o of i.edges){const c=On[o.type]??5;s[o.sourceIndex].push({nbr:o.targetIndex,rank:c}),s[o.targetIndex].push({nbr:o.sourceIndex,rank:c})}for(const o of s)o.sort((c,l)=>c.rank-l.rank||c.nbr-l.nbr);r[e]=0;const n=[e];for(let o=0;o<n.length;o++){const c=n[o];for(const{nbr:l}of s[c])r[l]===ke&&(r[l]=r[c]+1,n.push(l))}for(let o=0;o<t;o++)if(!(r[o]===ke||r[o]===0)){for(const{nbr:c}of s[o])if(r[c]===r[o]-1){a[o]=c;break}}return{depths:r,parents:a}}function Vn(i,e,t,r){const a=new Map;for(const s of i.nodes)a.set(s.id,s.createdAt);for(const s of[3,2,1]){const n=[];for(let p=0;p<e.nodes.length;p++){if(p===e.centerIndex||p===r)continue;const v=t[p];v===ke||v<s||n.push(p)}if(n.length===0)continue;let o=n.filter(p=>e.nodes[p].retention<=.45);o.length===0&&(o=n);const c=new Map;let l=1/0,d=-1/0;for(const p of o){const v=a.get(e.nodes[p].id),b=v?Date.parse(v):NaN;Number.isFinite(b)&&(c.set(p,b),b<l&&(l=b),b>d&&(d=b))}const f=p=>{const v=c.get(p);return v===void 0?0:d===l?1:(d-v)/(d-l)},h=p=>2*(1-e.nodes[p].retention)+.5*Math.min(t[p],6)/6+.5*f(p);return o.sort((p,v)=>{const b=h(p),w=h(v);return w!==b?w-b:t[v]!==t[p]?t[v]-t[p]:p-v}),{index:o[0],depth:t[o[0]]}}return{index:-1,depth:0}}function Wn(i,e,t,r,a){const s=i[t*re+0],n=i[t*re+1],o=i[t*re+2],c=[];for(let l=0;l<e;l++){if(l===t||l===r||l===a)continue;const d=i[l*re+0]-s,f=i[l*re+1]-n,h=i[l*re+2]-o;c.push({i:l,d2:d*d+f*f+h*h})}return c.sort((l,d)=>l.d2-d.d2||l.i-d.i),c.slice(0,Ln).map(l=>l.i)}function mt(i){const e=Math.max(1,i);return Math.min(84,Math.max(14,Math.floor(252/e)))}function Yn(i,e){return Math.min(ht+e*i,zn)}function hr(i){return Dn+Tn*i}function fe(i){return i.length>64?i.slice(0,64)+"…":i}const we=4;function Me(i){const e=new Uint32Array(i);return e.fill(ke),{viable:!1,failureIndex:-1,causeIndex:-1,lookalikeIndices:[],hopDepths:new Uint16Array(i).fill(ke),causeDepth:0,hopSlot:mt(3),waveData:e,pathData:new Uint32Array(4),pathMetas:[],spineBeats:[],verdict:{headline:"root cause found",causeLabel:"",failureLabel:"",causeDate:"",hops:0,k:0,receipt:""},consts:{hopSlot:mt(3),causeDepth:3}}}function Hn(i,e,t,r){var T;if(r)return Kn(i,e,r);const a=e.nodes.length;if(a===0)return Me(0);const s=Cr(e,t),n=jn(e,s);if(n<0)return Me(a);const{depths:o,parents:c}=qn(e,n),l=Vn(i,e,o,n);if(l.index<0){const x=Me(a);return x.failureIndex=n,x.hopDepths=o,x}const d=l.index,f=Math.max(1,l.depth),h=mt(f),p=x=>Yn(x,h),v=Wn(s,a,n,d,e.centerIndex),b=v.length,w=new Uint32Array(a);for(let x=0;x<a;x++){let G=o[x]&65535;x===n&&(G|=65536),x===d&&(G|=1<<17),w[x]=G}v.forEach((x,G)=>{w[x]|=1<<18|G<<19});const S=[];v.forEach((x,G)=>{S.push({src:n,dst:x,bf:hr(G),kind:de.probe,beatKind:"probe"})});const y=[];{let x=d;for(;x!==n&&x>=0&&c[x]>=0;)y.push(x),x=c[x]}const z=new Set(y),U=[];for(let x=0;x<a;x++){if(x===n||z.has(x))continue;const G=o[x];G===ke||G<1||G>f||c[x]<0||U.push(x)}U.sort((x,G)=>o[x]-o[G]||x-G);const ne=[...y.slice().reverse(),...U].slice(0,Un);ne.sort((x,G)=>o[x]-o[G]||x-G);for(const x of ne)S.push({src:c[x],dst:x,bf:p(o[x]),kind:de.backwardCause,beatKind:"wave"});S.push({src:d,dst:n,bf:fr,kind:de.backwardCause,beatKind:"arc"});const A=new Uint32Array(Math.max(1,S.length)*we),H=[];S.forEach((x,G)=>{A[G*we+0]=x.src,A[G*we+1]=x.dst,A[G*we+2]=x.bf,A[G*we+3]=x.kind,H.push({sourceIndex:x.src,targetIndex:x.dst,beatFrame:x.bf,kind:x.kind,beatKind:x.beatKind,nodeId:e.nodes[x.dst].id,label:fe(e.nodes[x.dst].label)})});const F=fe(e.nodes[n].label),K=fe(e.nodes[d].label),ie=[],ae=(x,G,Ke,Xe)=>{ie.push({sourceIndex:n,targetIndex:n,beatFrame:x,kind:G,beatKind:"rescue",nodeId:Xe,label:Ke})};ae(kr,1,`failure: ${F}`,e.nodes[n].id),v.forEach((x,G)=>{ae(hr(G),0,`lookalike ✗ · ${fe(e.nodes[x].label)}`,e.nodes[x].id)}),ae(p(1),1,"reaching backward through time","rescue-wave-start"),f>=2&&p(f)!==p(1)&&ae(p(f),1,`scrubbing past · ${f} hops`,"rescue-wave-deep"),ae(fr,1,`causal arc · ${K}`,e.nodes[d].id),ae(Rr,1,"root cause found","rescue-verdict");const ge=((T=i.nodes.find(x=>x.id===e.nodes[d].id))==null?void 0:T.createdAt)??"",le=ge?ge.slice(0,10):"",q={headline:"root cause found",causeLabel:K,failureLabel:F,causeDate:le,hops:f,k:b,receipt:`${f} hops back · ${le} · vector search: 0 for ${b}`};return{viable:!0,failureIndex:n,causeIndex:d,lookalikeIndices:v,hopDepths:o,causeDepth:f,hopSlot:h,waveData:w,pathData:A,pathMetas:H,spineBeats:ie,verdict:q,consts:{hopSlot:h,causeDepth:f}}}function Kn(i,e,t){var A,H;const r=e.nodes.length,a=e.indexById.get(t.failureId)??-1,s=t.pathIds??[];if(a<0||s.length<2||s[s.length-1]!==t.failureId||new Set(s).size!==s.length)return Me(r);const n=s.map(F=>e.indexById.get(F));if(n.some(F=>F===void 0))return Me(r);const o=n,c=o[0];if(c===a)return Me(r);const l=t.candidates.find(F=>F.memoryId===s[0]);if(!l)return Me(r);const d=new Uint16Array(r);d.fill(ke),d[a]=0,o.forEach((F,K)=>{d[F]=o.length-1-K});const f=new Uint32Array(r);f[a]=65536,o.slice(0,-1).forEach(F=>{f[F]=d[F]}),f[c]|=1<<17;const h=o.length-1,p=mt(h),v=fe(e.nodes[c].label),b=fe(e.nodes[a].label),w=((H=(A=i.nodes.find(F=>F.id===l.memoryId))==null?void 0:A.createdAt)==null?void 0:H.slice(0,10))??"",S=new Uint32Array((o.length-1)*we),y=o.slice(0,-1).map((F,K)=>{const ie=o[K+1],ae=ht+K*p;return S[K*we]=F,S[K*we+1]=ie,S[K*we+2]=ae,S[K*we+3]=de.backwardCause,{sourceIndex:F,targetIndex:ie,beatFrame:ae,kind:de.backwardCause,beatKind:"receipt-path",nodeId:s[K+1],label:`recorded path · ${fe(e.nodes[ie].label)}`}}),z=l.sharedEntities.length?l.sharedEntities.join(", "):"recorded entity",U=l.similarityRank===null?"rank unavailable":`embedding rank #${l.similarityRank}`,ne=[{sourceIndex:a,targetIndex:a,beatFrame:kr,kind:1,beatKind:"receipt-failure",nodeId:t.failureId,label:`recorded failure · ${b}`},{sourceIndex:a,targetIndex:a,beatFrame:ht,kind:1,beatKind:"receipt-join",nodeId:"receipt-join",label:`shared entity · ${z}`},{sourceIndex:c,targetIndex:a,beatFrame:ht+(h-1)*p,kind:de.backwardCause,beatKind:"receipt-candidate",nodeId:l.memoryId,label:`candidate · ${v}`},{sourceIndex:c,targetIndex:c,beatFrame:Rr,kind:1,beatKind:"receipt-verdict",nodeId:"receipt-verdict",label:"candidate cause found"}];return{viable:!0,failureIndex:a,causeIndex:c,lookalikeIndices:[],hopDepths:d,causeDepth:h,hopSlot:p,waveData:f,pathData:S,pathMetas:y,spineBeats:ne,verdict:{headline:"candidate cause found",causeLabel:v,failureLabel:b,causeDate:w,hops:h,k:0,receipt:`${l.ageDays.toFixed(1)}d back · ${z} · ${U}`},consts:{hopSlot:p,causeDepth:h}}}const Xn=`
struct Params {
	frame: f32,
	loop_phase: f32,
	node_count: f32,
...
`,Qn=3;class Zn{constructor(e){u(this,"engine");u(this,"nodeRenderer");u(this,"plan");u(this,"pipeline",null);u(this,"bindGroup",null);u(this,"horizonBuffer",null);this.engine=e.engine,this.nodeRenderer=e.nodeRenderer,this.plan=e.plan,this.engine.addPass(this)}upload(){var r;const e=this.engine.gpuDevice;if(!e||!this.engine.paramsBuffer||!this.plan.viable||!this.nodeRenderer.nodeStateBuffer||this.nodeRenderer.nodeCountValue===0)return;(r=this.horizonBuffer)==null||r.destroy(),this.horizonBuffer=e.createBuffer({label:"observatory-forgetting-horizon",size:Math.max(4,this.plan.horizonData.byteLength),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),e.queue.writeBuffer(this.horizonBuffer,0,this.plan.horizonData.buffer);const t=e.createShaderModule({label:"observatory-forgetting-choreo",code:Xn});this.pipeline=e.createComputePipeline({label:"observatory-forgetting-choreo",layout:"auto",compute:{module:t,entryPoint:"forgetting_choreo"}}),this.bindGroup=e.createBindGroup({label:"observatory-forgetting-bind",layout:this.pipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.engine.paramsBuffer}},{binding:1,resource:{buffer:this.nodeRenderer.nodeStateBuffer}},{binding:2,resource:{buffer:this.horizonBuffer}}]})}compute(e){if(this.engine.params[9]!==Qn||!this.pipeline||!this.bindGroup)return;const t=this.nodeRenderer.nodeCountValue;if(t===0)return;const r=e.beginComputePass({label:"observatory-forgetting-choreo"});r.setPipeline(this.pipeline),r.setBindGroup(0,this.bindGroup),r.dispatchWorkgroups(Math.ceil(t/64)),r.end()}dispose(){var e;(e=this.horizonBuffer)==null||e.destroy(),this.horizonBuffer=null,this.pipeline=null,this.bindGroup=null}}const Jn=318,$n=60,Er=3,ea=132,ta=60,ra=540,ia=660;function na(i){const e=[];for(let a=0;a<i.nodes.length;a++)a!==i.centerIndex&&e.push(a);e.sort((a,s)=>i.nodes[a].retention-i.nodes[s].retention||a-s);const t=e.length;if(t===0)return[];const r=Math.min(t,Math.max(Math.min(Er,t),Math.round(.25*t)));return e.slice(0,r)}function aa(i,e){const t=new Uint32Array(i.nodes.length);for(const s of i.edges)t[s.sourceIndex]++,t[s.targetIndex]++;const r=s=>2*i.nodes[s].retention+Math.min(t[s],8)/8;return e.slice().sort((s,n)=>r(n)-r(s)||s-n).slice(0,Math.min(Er,e.length))}function pr(i){return Jn+$n*i}const Ve=4;function sa(i){return{viable:!1,driftingIndices:[],rescuedIndices:[],horizonData:new Uint32Array(i),pathData:new Uint32Array(4),pathMetas:[],spineBeats:[]}}function oa(i){const e=i.nodes.length,t=na(i);if(e<2||t.length<1)return sa(e);const r=aa(i,t),a=t.length,s=new Uint32Array(e);t.forEach((h,p)=>{const v=Math.round(255*p/Math.max(1,a-1));s[h]=v&255|256}),r.forEach((h,p)=>{s[h]|=512|p<<10});const n=new Uint32Array(Math.max(1,r.length)*Ve),o=[];r.forEach((h,p)=>{const v=pr(p);n[p*Ve+0]=i.centerIndex,n[p*Ve+1]=h,n[p*Ve+2]=v,n[p*Ve+3]=de.recall,o.push({sourceIndex:i.centerIndex,targetIndex:h,beatFrame:v,kind:de.recall,beatKind:"recall",nodeId:i.nodes[h].id,label:fe(i.nodes[h].label)})});const c=[],l=(h,p,v,b)=>{c.push({sourceIndex:i.centerIndex,targetIndex:i.centerIndex,beatFrame:h,kind:p,beatKind:"horizon",nodeId:b,label:v})},d=new Set(r),f=t.filter(h=>!d.has(h)).slice(0,3);return f.forEach((h,p)=>{const v=Math.round(i.nodes[h].retention*100);l(ea+ta*p,1,`fading: ${fe(i.nodes[h].label)} · retention ${v}%`,i.nodes[h].id)}),r.forEach((h,p)=>{l(pr(p),0,`recalled: ${fe(i.nodes[h].label)}`,i.nodes[h].id)}),f.length>0&&l(ra,1,"the unrecalled sink · nothing is deleted","horizon-sink"),l(ia,0,"every memory still retrievable","horizon-retrievable"),{viable:!0,driftingIndices:t,rescuedIndices:r,horizonData:s,pathData:n,pathMetas:o,spineBeats:c}}const la=`
struct Params {
	frame: f32,
	loop_phase: f32,
	node_count: f32,
...
`,ca=4;class Mr{constructor(e){u(this,"engine");u(this,"nodeRenderer");u(this,"plan");u(this,"pipeline",null);u(this,"bindGroup",null);u(this,"fireBuffer",null);this.engine=e.engine,this.nodeRenderer=e.nodeRenderer,this.plan=e.plan,this.engine.addPass(this)}upload(){var r;const e=this.engine.gpuDevice;if(!e||!this.engine.paramsBuffer||!this.plan.viable||!this.nodeRenderer.nodeStateBuffer||this.nodeRenderer.nodeCountValue===0)return;(r=this.fireBuffer)==null||r.destroy(),this.fireBuffer=e.createBuffer({label:"observatory-firewall-fire",size:Math.max(4,this.plan.fireData.byteLength),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),e.queue.writeBuffer(this.fireBuffer,0,this.plan.fireData.buffer);const t=e.createShaderModule({label:"observatory-firewall-choreo",code:la});this.pipeline=e.createComputePipeline({label:"observatory-firewall-choreo",layout:"auto",compute:{module:t,entryPoint:"firewall_choreo"}}),this.bindGroup=e.createBindGroup({label:"observatory-firewall-bind",layout:this.pipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.engine.paramsBuffer}},{binding:1,resource:{buffer:this.nodeRenderer.nodeStateBuffer}},{binding:2,resource:{buffer:this.fireBuffer}}]})}rearm(e){if(this.plan=e,!!this.engine.gpuDevice){if(!e.viable){this.pipeline=null,this.bindGroup=null;return}this.upload()}}get armed(){return this.plan.viable&&!!this.pipeline&&!!this.bindGroup}compute(e){const t=this.engine.params[9]===ca,r=this.engine.params[12]===1;if(!t&&!r||!this.pipeline||!this.bindGroup)return;const a=this.nodeRenderer.nodeCountValue;if(a===0)return;const s=e.beginComputePass({label:"observatory-firewall-choreo"});s.setPipeline(this.pipeline),s.setBindGroup(0,this.bindGroup),s.dispatchWorkgroups(Math.ceil(a/64)),s.end()}dispose(){var e;(e=this.fireBuffer)==null||e.destroy(),this.fireBuffer=null,this.pipeline=null,this.bindGroup=null}}const da=90,ua=150,fa=144,ha=330,pa=345,ma=21,ga=6,va=480,ba=["failure","guardrail","confusion"];function ya(i){const e=i.nodes.length;if(e===0)return-1;const t=new Uint32Array(e);for(const s of i.edges)t[s.sourceIndex]++,t[s.targetIndex]++;const r=s=>i.nodes[s].tags.some(n=>ba.includes(n.toLowerCase())),a=[s=>s!==i.centerIndex&&!i.nodes[s].suppressed&&r(s),s=>s!==i.centerIndex&&!i.nodes[s].suppressed&&t[s]<=1,s=>s!==i.centerIndex&&!i.nodes[s].suppressed,s=>s!==i.centerIndex];for(const s of a){let n=-1;for(let o=0;o<e;o++)s(o)&&(n<0||i.nodes[o].retention<i.nodes[n].retention)&&(n=o);if(n>=0)return n}return-1}function _a(i,e,t){const r=i[t*re+0],a=i[t*re+1],s=i[t*re+2],n=new Array(e);let o=0;for(let l=0;l<e;l++){const d=i[l*re+0]-r,f=i[l*re+1]-a,h=i[l*re+2]-s,p=Math.sqrt(d*d+f*f+h*h);n[l]=p,p>o&&(o=p)}o<1e-6&&(o=1);const c=new Array(e);for(let l=0;l<e;l++)c[l]=Math.min(255,Math.max(0,Math.round(fa*n[l]/o)));return c[t]=0,c}function wa(i,e){const t=new Set;for(const r of i.edges)r.sourceIndex===e&&r.targetIndex!==e&&t.add(r.targetIndex),r.targetIndex===e&&r.sourceIndex!==e&&t.add(r.sourceIndex);return Array.from(t).sort((r,a)=>r-a).slice(0,ga)}function mr(i){return pa+ma*i}const We=4;function xa(i){return Tt(i)}function Tt(i){return{viable:!1,intruderIndex:-1,severedNeighborIndices:[],shockDelays:[],fireData:new Uint32Array(i),pathData:new Uint32Array(4),pathMetas:[],spineBeats:[],verdict:{headline:"threat quarantined",intruderLabel:"",receipt:"memory held in review · Memory PR opened"}}}function Pa(i,e){return Ar(i,e,ya(i))}function Ba(i,e,t){return t<0||t>=i.nodes.length?Tt(i.nodes.length):Ar(i,e,t)}function Ar(i,e,t){const r=i.nodes.length;if(r===0||t<0)return Tt(r);const a=Cr(i,e),s=_a(a,r,t),n=wa(i,t),o=new Uint32Array(r);for(let v=0;v<r;v++)o[v]=s[v]&255;o[t]=256,n.forEach((v,b)=>{o[v]|=512|b<<10});const c=new Uint32Array(Math.max(1,n.length)*We),l=[];n.forEach((v,b)=>{const w=mr(b);c[b*We+0]=t,c[b*We+1]=v,c[b*We+2]=w,c[b*We+3]=de.probe,l.push({sourceIndex:t,targetIndex:v,beatFrame:w,kind:de.probe,beatKind:"sever",nodeId:i.nodes[v].id,label:fe(i.nodes[v].label)})});const d=fe(i.nodes[t].label),f=[],h=(v,b,w)=>{f.push({sourceIndex:t,targetIndex:t,beatFrame:v,kind:1,beatKind:"firewall",nodeId:w,label:b})};return h(da,`intrusion · ${d}`,i.nodes[t].id),h(ua,"immune response · shockwave","firewall-shock"),h(ha,"membrane forming","firewall-membrane"),n.forEach((v,b)=>{h(mr(b),`edge severed ✗ · ${fe(i.nodes[v].label)}`,i.nodes[v].id)}),h(va,"threat quarantined","firewall-verdict"),{viable:!0,intruderIndex:t,severedNeighborIndices:n,shockDelays:s,fireData:o,pathData:c,pathMetas:l,spineBeats:f,verdict:{headline:"threat quarantined",intruderLabel:d,receipt:"memory held in review · Memory PR opened"}}}const bt=.1542;function Sa(i=bt){return Math.pow(.9,-1/i)-1}function Fr(i,e,t=bt){if(!(i>0))return 0;if(!(e>0))return 1;const r=Sa(t),a=Math.pow(1+r*e/i,-t);return a<0?0:a>1?1:a}const zt=864e5;function Ia(i,e,t=0){if(!i)return t>0?t:0;const r=Date.parse(i);if(!Number.isFinite(r))return t>0?t:0;const a=(e-r)/zt;return Math.max(0,a)+Math.max(0,t)}function ka(i,e,t,r,a=bt){if(t){const n=Date.parse(t);if(Number.isFinite(n)&&r<n)return 0}if(i===void 0||!Number.isFinite(i)||!e)return 1;const s=Date.parse(e);return Number.isFinite(s)?Math.max(.001,Fr(i,(r-s)/zt,a)):1}function Ra(i,e,t,r=0,a=bt){return i===void 0||!Number.isFinite(i)?1:Fr(i,Ia(e,t,r),a)}const gr={[te.firewall]:620,[te.dreamStorm]:360,[te.causalRecall]:260,[te.birth]:180};class Ca{constructor(e){u(this,"engine");u(this,"renderer");u(this,"graph");u(this,"response");u(this,"seed");u(this,"projectionDays");u(this,"chronoOffsetDays");u(this,"onApply");u(this,"onFirewall");u(this,"firewall",null);u(this,"liveEdges",[]);u(this,"liveEdgeKeys",new Set);u(this,"edgesDirty",!1);u(this,"indexById");u(this,"active",null);u(this,"dreamOpen",!1);u(this,"retention");u(this,"hasLiveDecay",!1);u(this,"eventsSeen",0);u(this,"lastDecayFrame",-1e3);u(this,"lastAppliedMs",0);u(this,"seeded",!1);u(this,"lastProj",-1);u(this,"lastChrono",0);this.engine=e.engine,this.renderer=e.renderer,this.graph=e.graph,this.response=e.response,this.seed=e.seed,this.projectionDays=e.projectionDays??(()=>0),this.chronoOffsetDays=e.chronoOffsetDays??(()=>0),this.onApply=e.onApply,this.onFirewall=e.onFirewall,this.indexById=e.graph.indexById;const t=e.graph.nodes.length;this.retention=new Float32Array(t);for(let a=0;a<t;a++){const s=e.graph.nodes[a];this.retention[a]=s.retention,s.stability!==void 0&&s.lastAccessed&&(this.hasLiveDecay=!0)}this.liveEdges=e.graph.edges.slice();for(const a of this.liveEdges)this.liveEdgeKeys.add(vr(a.sourceIndex,a.targetIndex));this.lastAppliedMs=0;const r=this.engine.params;r[se.liveKind]=te.none,r[se.liveFrame]=0,r[se.liveEnergy]=0,r[se.projectionDays]=0}get liveDecayAvailable(){return this.hasLiveDecay}seedWatermark(e){let t=0;for(const r of e){const a=br(r);a>t&&(t=a)}this.lastAppliedMs=t,this.seeded=!0}get hasActiveEvent(){return this.active!==null}replayRecall(e,t,r){if(this.active!==null)return!1;const a=this.indexById.get(e);if(a===void 0||(this.retention[a]??0)<5e-4)return!1;const s=t.filter(n=>n!==e&&this.indexById.has(n));return this.arm({kind:te.causalRecall,startFrame:r,targetId:e,relatedIds:s,pairs:[],scalar:s.length}),!0}ingest(e){if(e.length===0)return;if(!this.seeded){this.seedWatermark(e);return}let t=this.lastAppliedMs;for(let r=e.length-1;r>=0;r--){const a=e[r],s=br(a);s>this.lastAppliedMs&&(this.decodeAndArm(a,this.engine.totalFrames),s>t&&(t=s))}this.lastAppliedMs=t}decodeAndArm(e,t){var a;const r=e.data??{};switch(e.type){case"MemorySuppressed":{const s=Le(r.id);if(!s||!this.indexById.has(s))return;this.arm({kind:te.firewall,startFrame:t,targetId:s,relatedIds:this.neighborsOf(s),pairs:[],scalar:Ye(r.estimated_cascade)});break}case"DeepReferenceCompleted":{const n=Ea(r.contradiction_pairs).filter(([l,d])=>this.indexById.has(l)&&this.indexById.has(d));if(n.length>0){const l=n[0][0];this.arm({kind:te.firewall,startFrame:t,targetId:l,relatedIds:n.flatMap(d=>d).filter(d=>d!==l),pairs:n,scalar:n.length});return}const o=Le(r.primary_id),c=yr(r.supporting_ids).filter(l=>this.indexById.has(l));o&&this.indexById.has(o)&&this.arm({kind:te.causalRecall,startFrame:t,targetId:o,relatedIds:c,pairs:[],scalar:Ye(r.confidence)});break}case"BackfillFired":case"CausalReceipt":{const s=yr(r.path_ids??r.causal_path),n=Le(r.failure_id??r.target_id??r.effect_id)||s.at(-1)||s[0];n&&this.indexById.has(n)&&this.arm({kind:te.causalRecall,startFrame:t,targetId:n,relatedIds:s.filter(o=>o!==n),exactPath:s,pairs:[],scalar:s.length});break}case"DreamStarted":{this.dreamOpen=!0,this.arm({kind:te.dreamStorm,startFrame:t,targetId:"",relatedIds:[],pairs:[],scalar:Ye(r.memory_count)});break}case"DreamCompleted":{this.dreamOpen=!1;const s=Ye(r.connections_found);this.active&&this.active.kind===te.dreamStorm?this.active.scalar=Math.max(this.active.scalar,s):this.arm({kind:te.dreamStorm,startFrame:t,targetId:"",relatedIds:[],pairs:[],scalar:s});break}case"ConnectionDiscovered":{const s=this.indexById.get(Le(r.source_id)),n=this.indexById.get(Le(r.target_id));if(s===void 0||n===void 0||s===n)break;const o=vr(s,n);if(this.liveEdgeKeys.has(o))break;this.liveEdgeKeys.add(o),this.liveEdges.push({sourceIndex:s,targetIndex:n,weight:Ye(r.weight)||.5,type:Le(r.connection_type)||"semantic"}),this.edgesDirty=!0,this.dreamOpen&&((a=this.active)==null?void 0:a.kind)===te.dreamStorm&&(this.active.scalar+=1);break}}}arm(e){var t;if(this.active=e,this.eventsSeen++,e.kind===te.firewall){const r=this.indexById.get(e.targetId);if(r===void 0)return;const a=Ba(this.graph,this.seed,r);if(!a.viable)return;this.firewall||(this.firewall=new Mr({engine:this.engine,nodeRenderer:this.renderer,plan:xa(this.graph.nodes.length)})),this.firewall.rearm(a),(t=this.onFirewall)==null||t.call(this,{intruderLabel:a.verdict.intruderLabel,startFrame:e.startFrame})}if(e.kind===te.causalRecall&&this.indexById.has(e.targetId)){if(e.exactPath&&e.exactPath.length>1){const a=e.exactPath;if(a.some(o=>!this.indexById.has(o)))return;const s=new Uint32Array(Math.max(1,a.length-1)*4),n=[];for(let o=0;o<a.length-1;o++){const c=this.indexById.get(a[o]),l=this.indexById.get(a[o+1]),d=e.startFrame+24+o*42;s[o*4]=c,s[o*4+1]=l,s[o*4+2]=d,s[o*4+3]=de.backwardCause,n.push({sourceIndex:c,targetIndex:l,beatFrame:d,kind:de.backwardCause,beatKind:"receipt-path",nodeId:a[o+1],label:"receipt-backed candidate path"})}this.renderer.setPathSteps(s,n);return}const r=Ir(this.response,this.graph,8,{preferCausal:!0,centerId:e.targetId});r.steps.length>0&&this.renderer.setPathSteps(r.data,r.steps)}}neighborsOf(e){const t=this.indexById.get(e);if(t===void 0)return[];const r=[];for(const a of this.graph.edges)if(a.sourceIndex===t?r.push(this.graph.nodes[a.targetIndex].id):a.targetIndex===t&&r.push(this.graph.nodes[a.sourceIndex].id),r.length>=12)break;return r}drain(e){var n;const t=this.engine.params;this.edgesDirty&&(this.renderer.setEdges(this.liveEdges),this.edgesDirty=!1);const r=this.projectionDays(),a=this.chronoOffsetDays();if(t[se.projectionDays]=Math.max(0,r),(this.hasLiveDecay||a!==0||this.lastChrono!==0)&&(e-this.lastDecayFrame>=6||r!==this.lastProj||a!==this.lastChrono)&&(this.recomputeDecay(r,a),this.lastDecayFrame=e,this.lastProj=r,this.lastChrono=a),this.active){const o=gr[this.active.kind]??300,c=e-this.active.startFrame;c>o+140?(this.active=null,t[se.liveKind]=te.none,t[se.liveEnergy]=0):(t[se.liveKind]=this.active.kind,t[se.liveFrame]=Math.max(0,c),t[se.liveEnergy]=this.energyEnvelope(this.active,c,!1))}else t[se.liveKind]=te.none,t[se.liveEnergy]=0;(n=this.onApply)==null||n.call(this,{simFrame:e,activeKind:t[se.liveKind],eventsSeen:this.eventsSeen})}debugState(){const e=this.engine.params;return{activeKind:e[se.liveKind],liveEnergy:e[se.liveEnergy],liveFrame:e[se.liveFrame],edgeCount:this.liveEdges.length,eventsSeen:this.eventsSeen}}energyEnvelope(e,t,r){if(t<0)return 0;const a=gr[e.kind]??300;if(e.kind===te.dreamStorm){const o=Math.min(1,t/45),c=1-Math.max(0,(t-(a-90))/90),l=Math.min(1.4,.7+e.scalar*.02);return Math.max(0,o*Math.min(1,c)*l)}const s=Math.min(1,t/24),n=1-Math.max(0,(t-a)/140);return Math.max(0,s*Math.min(1,n))}recomputeDecay(e,t=0){const r=this.engine.wallNowMs,a=this.graph.nodes;if(t!==0){const s=r+(t+Math.max(0,e))*zt;for(let n=0;n<a.length;n++){const o=a[n];this.retention[n]=o.stability!==void 0||o.createdAt?ka(o.stability,o.lastAccessed,o.createdAt,s):Math.max(.001,o.retention)}}else for(let s=0;s<a.length;s++){const n=a[s];this.retention[s]=n.stability!==void 0&&n.lastAccessed?Ra(n.stability,n.lastAccessed,r,e):Math.max(.001,n.retention)}this.renderer.uploadLiveRetention(this.retention)}refreshDecay(){const e=this.chronoOffsetDays();(this.hasLiveDecay||e!==0||this.lastChrono!==0)&&(this.recomputeDecay(this.projectionDays(),e),this.lastChrono=e)}}function vr(i,e){return i<e?`${i}-${e}`:`${e}-${i}`}function br(i){var r;const e=(r=i.data)==null?void 0:r.timestamp;if(typeof e!="string")return 0;const t=Date.parse(e);return Number.isFinite(t)?t:0}function Le(i){return typeof i=="string"?i:""}function Ye(i){return typeof i=="number"&&Number.isFinite(i)?i:0}function yr(i){return Array.isArray(i)?i.filter(e=>typeof e=="string"):[]}function Ea(i){if(!Array.isArray(i))return[];const e=[];for(const t of i)Array.isArray(t)&&t.length>=2&&typeof t[0]=="string"&&typeof t[1]=="string"&&e.push([t[0],t[1]]);return e}const ct=512,Ct=4,Ma=`
struct Params {
	frame: f32,
	loop_phase: f32,
	node_count: f32,
...
`;function Ta(i,e){return Number.isFinite(i)?i:e}class za{constructor(e,t,r){u(this,"engine");u(this,"renderer");u(this,"sourceIndices");u(this,"resources",null);u(this,"projectionPipeline",null);u(this,"seedPipeline",null);u(this,"transportPipeline",null);u(this,"compositePipeline",null);u(this,"projectionLayout",null);u(this,"seedLayout",null);u(this,"transportLayout",null);u(this,"compositeLayout",null);u(this,"emitterCount");u(this,"active",!1);u(this,"dirty",!0);u(this,"lastComputedFrame",-_r);u(this,"disposed",!1);u(this,"disabledReason",null);u(this,"exposure",.42);u(this,"configBytes",new ArrayBuffer(ye));u(this,"configUints",new Uint32Array(this.configBytes));u(this,"configFloats",new Float32Array(this.configBytes));this.engine=e,this.renderer=t;const a=[...new Set([...r].filter(s=>Number.isFinite(s)&&s>=0))].sort((s,n)=>s-n).slice(0,Gt);this.sourceIndices=new Uint32Array(a),this.emitterCount=this.sourceIndices.length}get quality(){return this.disabledReason===null?"half-res-transport":"disabled"}get fallbackReason(){return this.disabledReason}setScrubbing(e){this.active=e,this.dirty=!0,this.engine.requestRender()}setExposure(e){this.exposure=Math.max(0,Math.min(.72,Ta(e,.42))),this.dirty=!0,this.engine.requestRender()}targetFrameRate(){return this.active?60:10}compute(e,t=0){if(this.disposed||this.disabledReason!==null||this.emitterCount===0)return;const r=this.engine.gpuDevice;if(!r||!this.engine.paramsBuffer)return;const a=this.renderer.getFossilLightSources();if(!a)return;const s=this.fieldDimensions();if(s===null)return;const n=t-this.lastComputedFrame;if(!(this.active||this.dirty||n<0||n>=_r))return;try{this.ensurePipelines(r),this.ensureResources(r,s.width,s.height,a)}catch{this.disable("GPU light field unavailable on this adapter");return}if(!this.resources||!this.projectionPipeline||!this.seedPipeline||!this.transportPipeline)return;this.writeConfig(r,0,this.resources.width,this.resources.height,0);const c=Math.ceil(this.resources.width/8),l=Math.ceil(this.resources.height/8),d=e.beginComputePass({label:"fossil-light-half-res-transport"});d.setPipeline(this.projectionPipeline),d.setBindGroup(3,this.resources.projectionBindGroup,[0]),d.dispatchWorkgroups(Math.ceil(this.emitterCount/64)),d.setPipeline(this.seedPipeline),d.setBindGroup(0,this.resources.seedBindGroup,[0]),d.dispatchWorkgroups(c,l);for(const[f,h,p]of[[1,4,this.resources.propagateABindGroup],[2,13,this.resources.propagateBBindGroup],[3,37,this.resources.propagateABindGroup]])this.writeConfig(r,f,this.resources.width,this.resources.height,h),d.setPipeline(this.transportPipeline),d.setBindGroup(1,p,[f*ut]),d.dispatchWorkgroups(c,l);d.end(),this.dirty=!1,this.lastComputedFrame=t}render(e){this.disabledReason!==null||!this.resources||!this.compositePipeline||this.emitterCount===0||(e.setPipeline(this.compositePipeline),e.setBindGroup(2,this.resources.compositeBindGroup,[3*ut]),e.draw(6))}dispose(){this.disposed||(this.disposed=!0,this.destroyResources(),this.projectionPipeline=null,this.seedPipeline=null,this.transportPipeline=null,this.compositePipeline=null,this.seedLayout=null,this.projectionLayout=null,this.transportLayout=null,this.compositeLayout=null)}fieldDimensions(){const e=Math.floor(this.engine.params[6]),t=Math.floor(this.engine.params[7]);if(e<2||t<2)return null;const r=e*.5*(t*.5),s=.5*Math.min(1,Math.sqrt(La/Math.max(1,r)));return{width:Math.max(1,Math.floor(e*s)),height:Math.max(1,Math.floor(t*s))}}ensurePipelines(e){if(this.projectionPipeline&&this.seedPipeline&&this.transportPipeline&&this.compositePipeline)return;const t=e.createShaderModule({label:"fossil-light-radiance-cascade-wgsl",code:Da}),r=e.createBindGroupLayout({label:"fossil-light-empty-layout",entries:[]});this.projectionLayout=e.createBindGroupLayout({label:"fossil-light-source-projection-layout",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform",hasDynamicOffset:!0,minBindingSize:ye}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:4,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]}),this.seedLayout=e.createBindGroupLayout({label:"fossil-light-seed-layout",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform",hasDynamicOffset:!0,minBindingSize:ye}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,storageTexture:{access:"write-only",format:Et}}]}),this.transportLayout=e.createBindGroupLayout({label:"fossil-light-transport-layout",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform",hasDynamicOffset:!0,minBindingSize:ye}},{binding:1,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"float",viewDimension:"2d"}},{binding:2,visibility:GPUShaderStage.COMPUTE,storageTexture:{access:"write-only",format:Et}}]}),this.compositeLayout=e.createBindGroupLayout({label:"fossil-light-composite-layout",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform",hasDynamicOffset:!0,minBindingSize:ye}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d"}}]}),this.seedPipeline=e.createComputePipeline({label:"fossil-light-seed",layout:e.createPipelineLayout({label:"fossil-light-seed-pipeline-layout",bindGroupLayouts:[this.seedLayout]}),compute:{module:t,entryPoint:"cs_seed"}}),this.projectionPipeline=e.createComputePipeline({label:"fossil-light-source-projection",layout:e.createPipelineLayout({label:"fossil-light-source-projection-pipeline-layout",bindGroupLayouts:[r,r,r,this.projectionLayout]}),compute:{module:t,entryPoint:"cs_project_sources"}}),this.transportPipeline=e.createComputePipeline({label:"fossil-light-transport",layout:e.createPipelineLayout({label:"fossil-light-transport-pipeline-layout",bindGroupLayouts:[r,this.transportLayout]}),compute:{module:t,entryPoint:"cs_transport"}}),this.compositePipeline=e.createRenderPipeline({label:"fossil-light-composite",layout:e.createPipelineLayout({label:"fossil-light-composite-pipeline-layout",bindGroupLayouts:[r,r,this.compositeLayout]}),vertex:{module:t,entryPoint:"vs_composite"},fragment:{module:t,entryPoint:"fs_composite",targets:[{format:this.engine.sceneFormat,blend:{color:{srcFactor:"src-alpha",dstFactor:"one",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one",operation:"add"}}}]}})}ensureResources(e,t,r,a){var p;if(((p=this.resources)==null?void 0:p.width)===t&&this.resources.height===r&&this.resources.nodeBuffer===a.nodeBuffer&&this.resources.cameraBuffer===a.cameraBuffer||(this.destroyResources(),!this.projectionLayout||!this.seedLayout||!this.transportLayout||!this.compositeLayout))return;const s=e.createBuffer({label:"fossil-light-projected-memory-emitters",size:Gt*Fa*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.STORAGE}),n=e.createBuffer({label:"fossil-light-source-indices",size:Math.max(4,this.sourceIndices.byteLength),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(n,0,this.sourceIndices.buffer,this.sourceIndices.byteOffset,this.sourceIndices.byteLength);const o=e.createBuffer({label:"fossil-light-cascade-config",size:ut*Ga,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),c=v=>e.createTexture({label:v,size:[t,r],format:Et,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.STORAGE_BINDING}),l=c("fossil-light-field-a"),d=c("fossil-light-field-b"),f=l.createView(),h=d.createView();this.resources={width:t,height:r,emitterBuffer:s,sourceIndexBuffer:n,configBuffer:o,fieldA:l,fieldB:d,seedBindGroup:e.createBindGroup({label:"fossil-light-seed-bind-group",layout:this.seedLayout,entries:[{binding:0,resource:{buffer:o,size:ye}},{binding:1,resource:{buffer:s}},{binding:2,resource:f}]}),propagateABindGroup:e.createBindGroup({label:"fossil-light-transport-a-to-b",layout:this.transportLayout,entries:[{binding:0,resource:{buffer:o,size:ye}},{binding:1,resource:f},{binding:2,resource:h}]}),propagateBBindGroup:e.createBindGroup({label:"fossil-light-transport-b-to-a",layout:this.transportLayout,entries:[{binding:0,resource:{buffer:o,size:ye}},{binding:1,resource:h},{binding:2,resource:f}]}),projectionBindGroup:e.createBindGroup({label:"fossil-light-source-projection-bind-group",layout:this.projectionLayout,entries:[{binding:0,resource:{buffer:o,size:ye}},{binding:1,resource:{buffer:n}},{binding:2,resource:{buffer:a.nodeBuffer}},{binding:3,resource:{buffer:a.cameraBuffer}},{binding:4,resource:{buffer:s}}]}),compositeBindGroup:e.createBindGroup({label:"fossil-light-composite-bind-group",layout:this.compositeLayout,entries:[{binding:0,resource:{buffer:o,size:ye}},{binding:1,resource:h}]}),nodeBuffer:a.nodeBuffer,cameraBuffer:a.cameraBuffer},this.dirty=!0}writeConfig(e,t,r,a,s){this.resources&&(this.configUints[0]=r,this.configUints[1]=a,this.configUints[2]=this.emitterCount,this.configUints[3]=s,this.configFloats[4]=this.exposure,this.configFloats[5]=1,e.queue.writeBuffer(this.resources.configBuffer,t*ut,this.configBytes))}destroyResources(){var e,t,r,a,s;(e=this.resources)==null||e.emitterBuffer.destroy(),(t=this.resources)==null||t.sourceIndexBuffer.destroy(),(r=this.resources)==null||r.configBuffer.destroy(),(a=this.resources)==null||a.fieldA.destroy(),(s=this.resources)==null||s.fieldB.destroy(),this.resources=null}disable(e){this.destroyResources(),this.disabledReason=e,this.engine.requestRender()}}var Ua=Z('<div class="flex items-baseline gap-2 font-mono text-[11px]"><span class="text-[#E9FFB7]/90 tabular-nums w-4"> </span> <span class="text-[#d8ded0]/90 truncate flex-1"> </span> <span class="text-[#A8FF5E]/80 tabular-nums whitespace-nowrap"> </span></div>'),Oa=Z(`<div class="absolute top-20 right-4 sm:right-6 max-w-[15rem] flex flex-col gap-1.5
					...
					hover:border-[#22C7DE]/50 transition-colors"> </button>`),qa=Z('<button class="text-[#d8ded0]/55 hover:text-[#d8ded0] transition-colors" title="Return to now">now</button>'),Va=Z('<div><span class="text-[#91ad8a]/80 uppercase whitespace-nowrap">Chrono</span> <input type="range" max="365" step="0.25" class="w-36 sm:w-52 accent-[#91ad8a] cursor-ew-resize opacity-75 hover:opacity-100 transition-opacity" aria-label="Scrub the memory field through time — back to the oldest memory, forward on the forgetting curve" title="Rewind the whole brain to any instant, or project it forward — every memory relit on its real FSRS curve"/> <span> </span> <!></div>'),Wa=Z(`<button class="absolute top-10 right-4 pointer-events-auto font-mono text-xs tracking-widest
					text-[#5dcaa5]/70 hover:text-[#5dcaa5] border border-[#5dcaa5]/25 hover:border-[#5dcaa5]/60
					bg-[#05060a]/70 rounded px-3 py-1.5 transition-colors" title="Exit Observatory (Esc)">× EXIT</button>`),Ya=Z("<button> </button>"),Ha=Z('<div class="absolute top-10 left-4 pointer-events-auto flex flex-col gap-1.5"></div>'),Ka=Z('<div class="absolute inset-0 flex items-center justify-center pointer-events-auto"><div class="text-[#5dcaa5] font-mono text-sm tracking-widest animate-pulse">LOADING MEMORY FIELD...</div></div>'),Xa=Z('<div class="absolute inset-0 flex items-center justify-center pointer-events-auto"><div class="text-red-400 font-mono text-sm border border-red-900/50 bg-red-950/30 px-4 py-2 rounded"> </div></div>'),Qa=Z('<div class="absolute inset-0 flex items-center justify-center pointer-events-auto"><div class="text-[#5dcaa5] font-mono text-sm tracking-widest">NO MEMORIES IN FIELD</div></div>'),Za=Z('<div class="absolute inset-0 z-10 pointer-events-none"><!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!></div>'),Ja=Z('<div class="pointer-events-none fixed left-4 bottom-24 z-30 font-mono text-[10px] tracking-widest text-[#7ff3e6]/80"> </div>'),$a=Z('<div><div role="application" aria-label="Interactive 3D memory field"><!></div> <!></div> <!> <!>',1);function bs(i,e){gt(e,!0);const t=()=>Bi(Ii,"$eventFeed",r),[r,a]=Si();let s=W(e,"seed",3,"vestige-observatory-v1"),n=W(e,"freezeFrame",3,null),o=W(e,"capture",3,!1),c=W(e,"showSwitcher",3,!0),l=W(e,"embedded",3,!1),d=W(e,"chrome",3,"full"),f=W(e,"maxDpr",3,2),h=W(e,"focusIds",19,()=>[]),p=W(e,"live",3,!1),v=W(e,"graphOverride",3,null),b=j(0),w=j(!1),S=j(0),y=null;const z=Ce(()=>Math.max(0,m(b))),U=Ce(()=>Math.min(0,m(b))),ne=Ce(()=>m(b)===0?"now":m(b)>0?`+${Math.round(m(b))}d`:new Date(Date.now()+m(b)*864e5).toLocaleDateString(void 0,{month:"short",day:"numeric"}));let A=null,H=null,F=null,K=j(!1),ie=j(!1);const ae=.835,ge=(1+.685)/2;let le=!1,q=0,T=0,x=0,G=!1;function Ke(g){var B;const _=(B=m(ve))==null?void 0:B.getBoundingClientRect();if(!_||_.width===0)return m(b);const C=(g-_.left)/_.width*2-1,O=Math.max(0,Math.min(1,C/ae*.5+.5));return m(S)+O*(365-m(S))}function Xe(g){var O;const _=(O=m(ve))==null?void 0:O.getBoundingClientRect();if(!_||_.height===0)return!1;const C=(g.clientY-_.top)/_.height;return C>ge-.075&&C<ge+.075}function yt(){q&&cancelAnimationFrame(q),q=0}function Gr(g){var _,C;!m(K)||o()||!Xe(g)||(yt(),le=!0,P(w,!0),T=0,x=performance.now(),P(b,Ke(g.clientX),!0),(C=(_=g.currentTarget).setPointerCapture)==null||C.call(_,g.pointerId),g.preventDefault())}function Lr(g){if(!le)return;const _=performance.now(),C=Ke(g.clientX),O=Math.max(1,_-x);T=T*.6+(C-m(b))/O*16*.4,x=_,P(b,C,!0)}function Dr(g){var C,O;if(!le)return;le=!1,G=!0,(O=(C=g.currentTarget).releasePointerCapture)==null||O.call(C,g.pointerId);const _=()=>{q=0,T*=.94;let B=m(b)+T;B<=m(S)&&(B=m(S),T=0),B>=365&&(B=365,T=0);const L=m(b)<0&&T>0||m(b)>0&&T<0;Math.abs(B)<1&&L&&(B=0,T=0),P(b,B,!0),Math.abs(T)>.02?q=requestAnimationFrame(_):P(w,!1)};Math.abs(T)>.05?q=requestAnimationFrame(_):P(w,!1)}function Tr(){le=!1,P(w,!1),yt()}let xe=j(!1),_t=j(!1);function zr(){if(typeof window>"u")return;const g=window.matchMedia("(prefers-reduced-motion: reduce)");g.matches&&!m(_t)&&P(xe,!0);const _=C=>{m(_t)||P(xe,C.matches,!0)};return g.addEventListener("change",_),()=>g.removeEventListener("change",_)}function Ut(){P(_t,!0),P(xe,!m(xe))}Ne(()=>{var g;(g=m(ce))==null||g.setPaused(m(xe))});let Qe=j(""),Ze=j(0),Ur=Ce(()=>m(Qe)!==""&&m(Ze)>0),ve=j(null);const pe=new sn;let wt=j(null),Ot=0,xt=j("");async function Or(g){var L;if(G){G=!1;return}if(!k||!m(ve))return;const _=m(ve).getBoundingClientRect();if(_.width===0||_.height===0)return;const C=(g.clientX-_.left)/_.width*2-1,O=-((g.clientY-_.top)/_.height*2-1),B=await k.pickAt(C,O);B&&(P(wt,{kind:"memory",id:B.id,label:"Field cell"},!0),(L=e.onpick)==null||L.call(e,B.id))}function Nr(g){Gr(g),!(le||o())&&(pe.enabled=!o(),pe.onPointerDown(g))}function jr(g){if(Lr(g),le||o())return;pe.onPointerMove(g)&&(G=!0,k==null||k.setCameraRig(pe.state));const _=performance.now();if(_-Ot<120||!k||!m(ve))return;Ot=_;const C=m(ve).getBoundingClientRect();if(C.width===0)return;const O=(g.clientX-C.left)/C.width*2-1,B=-((g.clientY-C.top)/C.height*2-1);k.pickAt(O,B).then(L=>{var V;k==null||k.setHovered((L==null?void 0:L.index)??-1),P(xt,((V=L==null?void 0:L.id)==null?void 0:V.slice(0,8))??"",!0),m(ve)&&(m(ve).style.cursor=L?"crosshair":"grab")})}function qr(g){Dr(g),pe.onPointerUp(g)}function Vr(){Tr(),pe.onPointerUp({pointerId:-1})}function Wr(g){o()||Xe(g)||pe.onWheel(g)&&(k==null||k.setCameraRig(pe.state))}const Nt={"recall-path":"RECALL","engram-birth":"BIRTH","salience-rescue":"RESCUE","forgetting-horizon":"HORIZON",firewall:"FIREWALL"};function Yr(){return k!=null&&k.graph?new Uint32Array(k.graph.nodes.map(g=>({index:g.index,id:g.id,retention:g.retention})).sort((g,_)=>_.retention-g.retention||g.id.localeCompare(_.id)).slice(0,64).map(g=>g.index).sort((g,_)=>g-_)):new Uint32Array}let Pt=j(!o());function Hr(g){const _=g.target;_!=null&&_.isContentEditable||(_==null?void 0:_.tagName)==="INPUT"||(_==null?void 0:_.tagName)==="TEXTAREA"||(_==null?void 0:_.tagName)==="SELECT"||((g.key==="h"||g.key==="H")&&P(Pt,!m(Pt)),g.key==="Escape"&&e.onexit&&e.onexit(),(g.key===" "||g.key.toLowerCase()==="p")&&!o()&&(g.preventDefault(),Ut()))}let be=j(null),Ae=j(!0),De=j(""),Te=j(0),jt=j(0),Je=j(0),$e=j(0),et=j(""),ce=j(null),k=null,tt=null,qt=null,Bt=j(null),Vt=null,Wt=null,ze=j(null),St=!1,Fe=j(ar([]));async function Kr(){P(Ae,!0),P(De,"");try{if(v()){P(be,v()),P(Je,v().nodeCount,!0),P($e,v().edgeCount,!0),P(et,v().center_id,!0);return}const g=new Set(h().filter(Boolean)),_=g.size?await(async()=>{var V,X;const C=await Promise.all([...g].map(N=>kt.graph({center_id:N,max_nodes:200,depth:3}))),O=[...new Map(C.flatMap(N=>N.nodes).map(N=>[N.id,N])).values()].filter(N=>g.has(N.id)),B=new Set(O.map(N=>N.id)),L=[...new Map(C.flatMap(N=>N.edges).map(N=>[`${N.source}:${N.target}`,N])).values()].filter(N=>B.has(N.source)&&B.has(N.target));return{...C[0],nodes:O,edges:L,center_id:((V=O[0])==null?void 0:V.id)??((X=C[0])==null?void 0:X.center_id)??"",nodeCount:O.length,edgeCount:L.length}})():await kt.graph({max_nodes:200,depth:3,sort:"connected"});P(be,_,!0),P(Je,_.nodeCount,!0),P($e,_.edgeCount,!0),P(et,_.center_id,!0)}catch(g){const _=g instanceof Error?g.message:"Failed to load graph data";/\b404\b/.test(_)?(P(be,{nodes:[],edges:[],nodeCount:0,edgeCount:0,center_id:""},!0),P(Je,0),P($e,0),P(et,"")):P(De,_,!0)}finally{P(Ae,!1)}}let rt=null,it=j(ar([])),nt=j("recalls");function Xr(g,_){P(Te,g,!0),P(jt,_,!0),rt&&!m(w)&&rt.tick(g)}async function Qr(){var V;if(!A||!(k!=null&&k.graph))return;const g=k.graph,_=X=>g.indexById.has(X),C=X=>{var N;return((N=g.nodes[g.indexById.get(X)??-1])==null?void 0:N.label)??X.slice(0,8)};let O=[];try{O=((V=await kt.receipts.list(60))==null?void 0:V.receipts)??[]}catch{}let B=Di(O,_);B.length===0&&(B=Ti(g.nodes,12)),B.length>0&&(rt=new Ui(A,{intervalFrames:240}),rt.setItems(B));const L=zi(O,_,3);L.length>0?(P(nt,"recalls"),P(it,L.map(X=>({...X,label:C(X.id)})),!0)):(P(nt,"retention"),P(it,[...g.nodes].filter(X=>(X.label??"").trim().length>0).sort((X,N)=>N.retention-X.retention).slice(0,3).map(X=>({id:X.id,recalls:Math.round(X.retention*100),label:X.label||X.id.slice(0,8)})),!0))}function Zr(g){var _;St=!1,P(ce,g,!0),k=new mn(g),pe.enabled=!o(),o()&&pe.reset(),k.setCameraRig(pe.state),(_=e.onready)==null||_.call(e,g)}Ne(()=>{if(m(ce)&&k&&m(be)&&!St){St=!0;const g=e.demo==="engram-birth",_=e.demo==="salience-rescue",C=e.demo==="forgetting-horizon",O=e.demo==="firewall";if(k.upload(m(be),s(),{recallPath:!g&&!_&&!C&&!O}),g){tt=new Mn({engine:m(ce),nodeRenderer:k,seed:s()}),tt.upload(s());const B=tt.engraveSteps,L=[];for(let V=0;V<B.length/4;V++)L.push({sourceIndex:B[V*4],targetIndex:B[V*4+1],beatFrame:B[V*4+2],kind:B[V*4+3],beatKind:"engrave",nodeId:`engrave-${V}`,label:"edge engraved"});k.setPathSteps(B,L),P(Fe,tt.timeline.map((V,X)=>({sourceIndex:0,targetIndex:0,beatFrame:V.startFrame,kind:0,beatKind:"birth",nodeId:`birth-${X}`,label:V.label})),!0)}else if(_){const B=Hn(m(be),k.graph,s(),e.backfillEvidence);P(Bt,B,!0),B.viable&&(qt=new Gn({engine:m(ce),nodeRenderer:k,plan:B}),qt.upload(),k.setPathSteps(B.pathData,B.pathMetas)),P(Fe,B.spineBeats,!0)}else if(C){const B=oa(k.graph);B.viable&&(Vt=new Zn({engine:m(ce),nodeRenderer:k,plan:B}),Vt.upload(),k.setPathSteps(B.pathData,B.pathMetas)),P(Fe,B.spineBeats,!0)}else if(O){const B=Pa(k.graph,s());P(ze,B,!0),B.viable&&(Wt=new Mr({engine:m(ce),nodeRenderer:k,plan:B}),Wt.upload(),k.setPathSteps(B.pathData,B.pathMetas)),P(Fe,B.spineBeats,!0)}else P(Fe,k.pathSteps,!0);if(p()&&k.graph&&m(be)){A=new Ca({engine:m(ce),renderer:k,graph:k.graph,response:m(be),seed:s(),projectionDays:()=>m(z),chronoOffsetDays:()=>m(U),onFirewall:L=>{P(Qe,L.intruderLabel,!0),P(Ze,Date.now(),!0)}}),P(ie,A.liveDecayAvailable,!0),m(ce).setPreFrameHook(L=>A==null?void 0:A.drain(L)),o()||Qr();let B=Number.POSITIVE_INFINITY;for(const L of k.graph.nodes)if(L.createdAt){const V=Date.parse(L.createdAt);Number.isFinite(V)&&V<B&&(B=V)}if(Number.isFinite(B)&&P(S,Math.floor((B-Date.now())/864e5)-1),y){const L=Date.parse(y);Number.isFinite(L)&&P(b,Math.min(365,Math.max(m(S),(L-Date.now())/864e5)),!0),y=null}o()||(F=new za(m(ce),k,Yr()),m(ce).addPass(F),H=new Aa(m(ce),k.graph.nodes),m(ce).addPass(H),P(K,!0)),typeof window<"u"&&(window.__vestigeLiveBridge=A)}m(ce).demoClock.reset()}}),Ne(()=>{const g=t();A&&A.ingest(g)}),Ne(()=>{m(b),A==null||A.refreshDecay(),H==null||H.setTimeline(m(b),m(w)),F==null||F.setScrubbing(m(w))}),Ne(()=>{if(!m(Ze))return;const g=setTimeout(()=>{P(Qe,""),P(Ze,0)},7e3);return()=>clearTimeout(g)}),bi(()=>{y=new URLSearchParams(window.location.search).get("t"),Kr();const g=zr();return()=>{if(yt(),g==null||g(),typeof window<"u"){const _=window;_.__vestigeLiveBridge===A&&delete _.__vestigeLiveBridge}}});var Yt=$a();Oe("keydown",yi,Hr);var at=Lt(Yt);let Ht;var me=M(at);let Kt;var Jr=M(me);Ci(Jr,{get demo(){return e.demo},get seed(){return s()},get freezeFrame(){return n()},get maxDpr(){return f()},onframe:Xr,onready:Zr}),E(me),wi(me,g=>P(ve,g),()=>m(ve));var $r=D(me,2);{var ei=g=>{var _=Za(),C=M(_);{var O=I=>{var R=Oa(),$=M(R),Q=M($,!0);E($);var ue=D($,2);Mt(ue,19,()=>m(it),Be=>Be.id,(Be,Se,It)=>{var Ue=Ua(),Pe=M(Ue),st=M(Pe,!0);E(Pe);var ot=D(Pe,2),pi=M(ot,!0);E(ot);var nr=D(ot,2),mi=M(nr);E(nr),E(Ue),oe(()=>{ee(st,m(It)+1),Re(ot,"title",m(Se).label),ee(pi,m(Se).label),ee(mi,`${m(Se).recalls??""}${m(nt)==="recalls"?"×":"%"}`)}),Y(Be,Ue)}),E(R),oe(()=>ee(Q,m(nt)==="recalls"?"Most recalled · your mind":"Strongest memories · your mind")),Y(I,R)};J(C,I=>{p()&&m(it).length>0&&I(O)})}var B=D(C,2);{var L=I=>{var R=Na(),$=D(M(R),2),Q=M($,!0);E($),_i(2),E(R),oe(()=>ee(Q,m(Qe))),Y(I,R)};J(B,I=>{p()&&m(Ur)&&I(L)})}var V=D(B,2);{var X=I=>{var R=ja(),$=M(R,!0);E(R),oe(()=>{Re(R,"title",m(xe)?"Resume field motion":"Pause field motion"),Re(R,"aria-pressed",m(xe)),Re(R,"aria-label",m(xe)?"Resume 3D memory field motion":"Pause 3D memory field motion"),ee($,m(xe)?"▶ RESUME":"❚❚ PAUSE")}),he("click",R,Ut),Y(I,R)};J(V,I=>{o()||I(X)})}var N=D(V,2);{var ii=I=>{var R=Va();let $;var Q=D(M(R),2);xi(Q);var ue=D(Q,2);let Be;var Se=M(ue,!0);E(ue);var It=D(ue,2);{var Ue=Pe=>{var st=qa();he("click",st,()=>P(b,0)),Y(Pe,st)};J(It,Pe=>{m(b)!==0&&Pe(Ue)})}E(R),oe(()=>{$=Ee(R,1,`absolute bottom-3 left-1/2 -translate-x-1/2 pointer-events-auto
					flex items-center gap-3 px-3 py-1.5 rounded-full border border-[#91ad8a]/20
					bg-[#05060a]/45 backdrop-blur-[2px] font-mono text-[10px] tracking-[0.14em]`,null,$,{"opacity-100":m(K),"opacity-75":!m(K)}),Re(Q,"min",m(S)),Be=Ee(ue,1,"w-16 text-right tabular-nums",null,Be,{"text-[#b9d9a9]":m(b)>=0,"text-[#dfc68e]":m(b)<0}),ee(Se,m(ne))}),he("input",Q,()=>P(w,!0)),he("change",Q,()=>P(w,!1)),he("pointerup",Q,()=>P(w,!1)),Oe("pointercancel",Q,()=>P(w,!1)),Oe("blur",Q,()=>P(w,!1)),Pi(Q,()=>m(b),Pe=>P(b,Pe)),Y(I,R)};J(N,I=>{p()&&m(ie)&&I(ii)})}var Qt=D(N,2);{var ni=I=>{Vi(I,{get demoMode(){return e.demo},get seed(){return s()},get nodeCount(){return m(Je)},get edgeCount(){return m($e)},get centerId(){return m(et)},get frameCount(){return m(Te)},get fpsEstimate(){return m(jt)},get freezeFrame(){return n()},get loading(){return m(Ae)},get error(){return m(De)}})};J(Qt,I=>{d()==="full"&&I(ni)})}var Zt=D(Qt,2);{var ai=I=>{var R=Wa();he("click",R,function(...$){var Q;(Q=e.onexit)==null||Q.apply(this,$)}),Y(I,R)};J(Zt,I=>{d()==="full"&&e.onexit&&I(ai)})}var Jt=D(Zt,2);{var si=I=>{var R=Ha();Mt(R,20,()=>Ei,$=>$,($,Q)=>{var ue=Ya(),Be=M(ue,!0);E(ue),oe(()=>{Ee(ue,1,`font-mono text-[11px] tracking-widest text-left rounded px-3 py-1.5 border transition-colors
							${Q===e.demo?"text-[#05060a] bg-[#5dcaa5] border-[#5dcaa5]":"text-[#5dcaa5]/60 hover:text-[#5dcaa5] bg-[#05060a]/70 border-[#5dcaa5]/20 hover:border-[#5dcaa5]/50"}`),Re(ue,"title",`Play the ${Nt[Q]??""} moment`),ee(Be,Nt[Q])}),he("click",ue,()=>{var Se;return(Se=e.ondemochange)==null?void 0:Se.call(e,Q)}),Y($,ue)}),E(R),Y(I,R)};J(Jt,I=>{d()==="full"&&c()&&I(si)})}var $t=D(Jt,2);{var oi=I=>{var R=Ka();Y(I,R)};J($t,I=>{m(Ae)&&I(oi)})}var er=D($t,2);{var li=I=>{var R=Xa(),$=M(R),Q=M($,!0);E($),E(R),oe(()=>ee(Q,m(De))),Y(I,R)};J(er,I=>{m(De)&&!m(Ae)&&I(li)})}var tr=D(er,2);{var ci=I=>{Ki(I,{get steps(){return m(Fe)},get frame(){return m(Te)}})};J(tr,I=>{d()==="full"&&I(ci)})}var rr=D(tr,2);{var di=I=>{sr(I,{get frame(){return m(Te)},get verdict(){return m(Bt).verdict}})};J(rr,I=>{var R;d()==="full"&&e.demo==="salience-rescue"&&((R=m(Bt))!=null&&R.viable)&&I(di)})}var ir=D(rr,2);{var ui=I=>{{let R=Ce(()=>({headline:m(ze).verdict.headline,causeLabel:m(ze).verdict.intruderLabel,receipt:m(ze).verdict.receipt}));sr(I,{get frame(){return m(Te)},tone:"quarantine",fadeWindow:[480,495,605,620],get verdict(){return m(R)}})}};J(ir,I=>{var R;d()==="full"&&e.demo==="firewall"&&((R=m(ze))!=null&&R.viable)&&I(ui)})}var fi=D(ir,2);{var hi=I=>{var R=Qa();Y(I,R)};J(fi,I=>{!m(Ae)&&m(be)&&m(be).nodeCount===0&&I(hi)})}E(_),Y(g,_)};J($r,g=>{m(Pt)&&g(ei)})}E(at);var Xt=D(at,2);Li(Xt,{get pick(){return m(wt)},onclose:()=>P(wt,null)});var ti=D(Xt,2);{var ri=g=>{var _=Ja(),C=M(_);E(_),oe(()=>ee(C,`HOVER ${m(xt)??""}`)),Y(g,_)};J(ti,g=>{m(xt)&&!o()&&g(ri)})}oe(()=>{Ht=Ee(at,1,`${l()?"absolute":"fixed"} inset-0 overflow-hidden bg-[#05060a]`,null,Ht,{"cursor-none":o()}),Kt=Ee(me,1,"absolute inset-0 z-0 touch-none",null,Kt,{"cursor-crosshair":!!e.onpick&&!o()})}),he("click",me,Or),he("pointerdown",me,Nr),he("pointermove",me,jr),he("pointerup",me,qr),Oe("pointercancel",me,Vr),Oe("wheel",me,Wr),Y(i,Yt),vt(),a()}wr(["click","pointerdown","pointermove","pointerup","input","change"]);export{bs as O};
