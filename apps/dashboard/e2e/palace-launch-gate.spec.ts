...
// The disposable fixture has twelve memories. Pixel coverage scales with
// corpus size and DOM reading panels, so the smoke gate measures non-black
// luminance, spatial structure and motion instead of assuming the historical
// thousand-memory field's 30% bright-pixel occupancy. Record fill for inspection.
