//! Sync storage operations, extracted from the integrated v3 implementation.
...
impl SqliteMemoryStore {
    ...
    pub(super) fn merge_portable_table(
    ...
    pub(super) fn merge_knowledge_nodes(
        tx: &rusqlite::Transaction<'_>,
        table: &PortableTable,
        report: &mut PortableImportReport,
        state: &mut PortableMergeState,
    ...
    pub(super) fn merge_sync_tombstones(
        tx: &rusqlite::Transaction<'_>,
        table: &PortableTable,
        report: &mut PortableImportReport,
    ) -> Result<()> {
    ...
    pub(super) fn merge_deletion_tombstones(
        tx: &rusqlite::Transaction<'_>,
        table: &PortableTable,
        report: &mut PortableImportReport,
    ) -> Result<()> {
    ...
    pub(super) fn merge_keyed_table(
        tx: &rusqlite::Transaction<'_>,
        table_name: &str,
        table: &PortableTable,
        key_columns: &[&str],
    ...
    pub(super) fn row_references_locally_newer_node(
        table_name: &str,
        table: &PortableTable,
        row: &[PortableValue],
        state: &PortableMergeState,
    ...
    pub(super) fn merge_append_only_table(
        tx: &rusqlite::Transaction<'_>,
        table_name: &str,
        table: &PortableTable,
        report: &mut PortableImportReport,
    ...
    pub(super) fn parent_rows_exist(
        tx: &rusqlite::Transaction<'_>,
        table_name: &str,
        table: &PortableTable,
        row: &[PortableValue],
    ...
    pub(super) fn insert_or_replace_row(
        tx: &rusqlite::Transaction<'_>,
        table_name: &str,
        table: &PortableTable,
        row: &[PortableValue],
    ...
    pub(super) fn merge_key_columns(table_name: &str) -> &'static [&'static str] {
        match table_name {
    ...
    pub(super) fn upsert_row_with_columns(
        tx: &rusqlite::Transaction<'_>,
        table_name: &str,
        columns: &[String],
        values: Vec<Value>,
    ...
    pub(super) fn insert_row_with_columns(
        tx: &rusqlite::Transaction<'_>,
        table_name: &str,
        columns: &[String],
        values: Vec<Value>,
    ...
    pub(super) fn row_exists_by_values(
        tx: &rusqlite::Transaction<'_>,
        table_name: &str,
        columns: &[String],
        values: &[Value],
    ...
    pub(super) fn row_values_for_columns(
        table: &PortableTable,
        row: &[PortableValue],
        columns: &[String],
    ) -> Result<Vec<Value>> {
    ...
    pub(super) fn portable_timestamp(
        table: &PortableTable,
        row: &[PortableValue],
        column: &str,
    ) -> Option<DateTime<Utc>> {
    ...
    pub(super) fn parse_rfc3339_opt(value: &str) -> Option<DateTime<Utc>> {
        DateTime::parse_from_rfc3339(value)
            .map(|dt| dt.with_timezone(&Utc))
            .ok()
    }

    pub(super) fn tombstone_timestamp(
        tx: &rusqlite::Transaction<'_>,
        table_name: &str,
        row_id: &str,
    ...
    pub(super) fn has_opaque_tombstone(
        tx: &rusqlite::Transaction<'_>,
        table_name: &str,
        row_id: &str,
    ) -> Result<bool> {
    ...
    pub(super) fn ensure_portable_import_target_empty(conn: &Connection) -> Result<()> {
    ...
    pub(super) fn portable_value_from_ref(value: ValueRef<'_>) -> rusqlite::Result<PortableValue> {
        Ok(match value {
