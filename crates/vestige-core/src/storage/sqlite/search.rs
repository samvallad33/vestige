//! Search storage operations, extracted from the integrated v3 implementation.
...
impl SqliteMemoryStore {
    ...
    pub(super) fn upsert_concrete_result(
    ...
    pub(super) fn normalize_literal_query(query: &str) -> String {
    ...
    pub(super) fn literal_match_score(query: &str, node: &KnowledgeNode) -> Option<f32> {
    ...
    pub(super) fn node_matches_type_filters(
        node: &KnowledgeNode,
        include_types: Option<&[String]>,
        exclude_types: Option<&[String]>,
    ) -> bool {
